...
\feat{Armored Stealth}      & \feat{Innate Hunter} \\
\feat{Brutal Attack}        & \feat{Kiltektet} \\
\feat{Bug Trainer}          & \feat{Linguist} \\
\feat{Cloak Dance}          & \feat{Martial Performer} \\
...
\feat{Extra Performance}    & \feat{Reign of Terror} \\
\feat{Faithful Follower}    & \feat{Rogue Performer} \\
\feat{Favorite}             & \feat{Secular Authority} \\
\feat{Fearsome}             & \feat{Sniper} \\
\feat{Greasing the Wheels}  & \feat{Wastelander} \\
