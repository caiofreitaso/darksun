...
contents={%
  ...
  \else
    \ifodd\value{page}
      \includegraphics[width=\paperwidth]{images/background-odd.pdf}
    \else
      \includegraphics[width=\paperwidth]{images/background-even.pdf}
    \fi
  \fi
}
}
...
\pagepdf*{images/color-gladiator.pdf}
