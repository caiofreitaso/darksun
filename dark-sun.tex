  ...
  \else
    \ifblankpage
      ...
      \begin{tikzpicture}[remember picture,overlay,baseline=0,blend mode=multiply,every node/.style={inner ysep=0,inner xsep=0}]
          \node at (0,0) {\includegraphics[height=\paperheight]{images/color-paper.jpg}};
    ...
    \else
      \ifodd\value{page}
        \begin{tikzpicture}[remember picture,overlay,baseline=0,every node/.style={inner ysep=0,inner xsep=0}]
          \node at (0,0) {\includegraphics[height=\paperheight]{images/color-paper-2.jpg}};
          \begin{scope}[blend mode=multiply]
          \node[xscale=-1] at (0.2mm,0) {\includegraphics[width=\paperwidth]{images/background-filled-even.pdf}};
          \end{scope}
          \begin{scope}[blend mode=normal]
          \node[xscale=-1] at (0,0) {\includegraphics[width=\paperwidth]{images/background-highlights.pdf}};
          \end{scope}
        \end{tikzpicture}
      \else
        \begin{tikzpicture}[remember picture,overlay,baseline=0,every node/.style={inner ysep=0,inner xsep=0}]
          \node at (0.5mm,0) {\includegraphics[height=\paperheight]{images/color-paper-2.jpg}};
          \begin{scope}[blend mode=multiply]
...
\def\@part[#1]#2{%
  ...
  {
    \centering
    \fontsize{40pt}{40pt}\bfseries\contourlength{0.5pt}
    {
      \begin{textblock*}{\textwidth}(2cm,77mm)
      \centering
      {\color{ChapterColor}\contour{richblack}{\thepart}}
      \end{textblock*}
      \begin{textblock*}{\textwidth}(2cm,143mm)
      \centering
      {\color{ChapterColor}\contour{white}{#2}}\par
      \end{textblock*}
    }
  }
...
\newcommand\whitepage{\clearpage\global\whitepagetrue\thispagestyle{empty}\mbox{}\clearpage\global\whitepagefalse}
...
\blankpage
\part{Universae Grimoire}
\pagepdf{images/color-cleric-2.pdf}
...
\pagepdf*{images/color-planes.pdf}
