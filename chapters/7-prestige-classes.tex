...
% \input{sections/7-black-cassock.tex}
\input{sections/7-cerebremancer.tex}
...
\input{sections/7-hierophant.tex}
\input{sections/7-horizon-walker.tex}
\input{sections/7-jaguar-knight.tex}
\input{sections/7-loremaster.tex}
\input{sections/7-master-scout.tex}
\input{sections/7-metamind.tex}
\input{sections/7-mystic-theurge.tex}
\input{sections/7-shadowdancer.tex}
\input{sections/7-thaumaturgist.tex}