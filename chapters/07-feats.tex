...
\textit{Cognizance Crystal:} Base price = power level $\times$ manifester level $\times$ 25 cp.

\textit{Psionic Tattoos:} Base price = power level $\times$ manifester level $\times$ 2,000 cp.
