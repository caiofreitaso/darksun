...
Halfling   & Humanoid (halfling) &    & $-4$ Strength, +4 Dexterity, +4 Wisdom,
                                        \newline$-4$ Charisma                             & Druid, ranger, or rogue & Halfling \\
...
\input{sections/races/humans.tex}
% \input{sections/races/aarakocra.tex}
\vskip4cm
\input{sections/races/dwarves.tex}
\input{sections/races/elves.tex}
% \vskip4cm
\input{sections/races/half-elves.tex}
% \vskip4cm
\input{sections/races/half-giants.tex}
% \vskip4cm
\input{sections/races/halflings.tex}
\input{sections/races/muls.tex}
% \input{sections/races/pterrans.tex}
\input{sections/races/thri-kreen.tex}
