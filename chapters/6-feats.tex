...
\input{sections/6-feat-table.tex}
% \input{sections/6-tables-general-feats.tex}
\input{sections/6-general-feats.tex}
% \input{sections/6-tables-skill-feats.tex}
\input{sections/6-skill-feats.tex}
\input{sections/6-racial-feats.tex}
\input{sections/6-fighter-feats.tex}
\input{sections/6-feat-table-2.tex}
\input{sections/6-psionic-feats.tex}
\input{sections/6-feat-table-3.tex}
\input{sections/6-divine-feats.tex}
\input{sections/6-raze-feats.tex}
% \input{sections/6-regional-feats.tex}
\input{sections/6-metapsionic-feats.tex}
\input{sections/6-metamagic-feats.tex}
\input{sections/6-item-creation-feats.tex}