...
Illumine Soul\textsuperscript{CP}     & Master Specialist\textsuperscript{CM} \\
Psibond Agents\textsuperscript{CS}    & Mindbender\textsuperscript{CAr} \\
Shadowmind\textsuperscript{CAd}       & Nightmare Spinner\textsuperscript{CM} \\
Storm Disciple\textsuperscript{CP}    & Unseen Seer\textsuperscript{CM} \\
\\
\cmidrule[0pt]{1-2}
