...
Master Specialist\textsuperscript{CM} & Virtuoso\textsuperscript{CAd} \\
Mindbender\textsuperscript{CAr}       & Unseen Seer\textsuperscript{CM} \\
\cmidrule[0pt]{1-2}
\\

\cmidrule[0pt]{1-2}
\TableSubheader{Divine Casters}   & \TableSubheader{Psionicists} \\
Blighter\textsuperscript{CD}      & Ectopic Adept\textsuperscript{CP} \\
Contemplative\textsuperscript{CD} & Psibond Agent\textsuperscript{CS} \\
Divine Oracle\textsuperscript{CD} & \\
Entropomancer\textsuperscript{CD} & \\
Holt Warden\textsuperscript{CC}   & \\
Sacred Fist\textsuperscript{CD}   & \\
