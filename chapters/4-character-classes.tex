...
\input{sections/4.1-barbarian.tex}
\input{sections/4.2-bard.tex}
\input{sections/4.3-cleric.tex}
\input{sections/4.4-druid.tex}
\input{sections/4.5-fighter.tex}
\input{sections/4.6-gladiator.tex}
\input{sections/4.7-psion.tex}
\input{sections/4.8-psychic-warrior.tex}
\input{sections/4.9-ranger.tex}
\input{sections/4.10-rogue.tex}
\input{sections/4.11-templar.tex}
\input{sections/4.12-wilder.tex}
\input{sections/4.13-wizard.tex}
\input{sections/4.14-multiclass-characters.tex}
\input{sections/4.15-alternate-class-features.tex}