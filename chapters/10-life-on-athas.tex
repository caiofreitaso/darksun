...
\input{sections/10-religion.tex}
\input{sections/10-the-world-of-athas.tex}
\input{sections/10-balic.tex}
\input{sections/10-draj.tex}
\input{sections/10-gulg.tex}
\input{sections/10-nibenay.tex}
\input{sections/10-raam.tex}
\input{sections/10-tyr.tex}
\input{sections/10-urik.tex}
\input{sections/10-beyond-the-tablelands.tex}