...
\textbf{Feats:} \feat{Point Blank Shot}, \feat{Weapon Focus} (bow), \feat{Weapon Specialization} (bow).
...
Characters with ranks in \skill{Knowledge} (warcraft) can research arrow knights to learn more about them. When a character makes a skill check, read or paraphrase the following, including the information from lower DCs.
