...
\begin{enumerate*}
\item \psionicList{Control Sound}:
...
\item \psionicList{Control Flames}\textsuperscript{P}:
      ...
      \psionicList{Project Force}\textsuperscript{P}: Punch someone from afar.
...
\item \psionicList{Control Wind}\textsuperscript{P}:
      ...
      \psionicList{Molecular Rearrangement}: Change an object's properties.
\item
