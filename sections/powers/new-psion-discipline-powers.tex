...
\Figure*[\textwidth-15mm]{t}{images/psionic-2.png}
...
\item \psionicList{Adapt Body}\textsuperscript{A}: Your body automatically adapts to hostile environments.
      ...
      \psionicList{Body Equilibrium}: Your body adapts its weight to allow walking on any surface.
      ...
      % \psionicList{Charm Vermin}: As \spell{charm person}, but for vermin.
...
\item \psionicList{Adrenaline Control}: Increase Strength, Dexterity, or Constitution by 1d6.
      ...
      \psionicList{Secrete Acid}: Destroy fragile objects, or 1d4 damage to creatures.
...
\item \psionicList{Aging}: Victim ages 2d4 years.
      ...
      \psionicList{Claws of the Beast}\textsuperscript{A}: Your hands become deadly claws. %XPH

      \psionicList{Displacement, Psionic}: Attacks miss subject 50\%.

      \psionicList{Enhance Physique}: Turn your Strength or Dexterity score to 18.
      ...
      \psionicList{Secrete Poison}: Secrete poison or its antidote.
...
\item \psionicList{Heal, Personal}\textsuperscript{AP}: Cures 120 points of damage, all diseases and mental conditions.
      ...
      \psionicList{Rigidity}\textsuperscript{P}: Nullify target's Dexterity.

      \psionicList{Suspend Life}: Put yourself or another into a state akin to suspended animation. %XPH
...
\item \psionicList{Elemental Composition}\textsuperscript{P}: Transform into an elemental.
\end{enumerate*}
...
\item \psionicList{Compact}: Reduce the size of a volume of any material to 10\% of its original volume.
      ...
      \psionicList{Matter Stability}: You freeze a creature or object.

      \psionicList{Returning Weapon}: Thrown weapon or ammunition gains the \emph{returning} special ability.
...
\item \psionicList{Control Body}\textsuperscript{P}: Take rudimentary control of your foe's limbs.
      ...
      \psionicList{Matter Manipulation}\textsuperscript{P}: Decrease an object's hit points to the point of breaking.
...
\item \psionicList{Control Wind}\textsuperscript{P}: You have control over wind speed and direction.

      \psionicList{Detonate}\textsuperscript{P}: Explode small objects or destroy one construct or undead creature.

      \psionicList{Matter Bonding}\textsuperscript{P}: Join two surfaces together.
...
\item \psionicList{Kinetic Control}: Gain a kinetic storage that absorbs physical damage, and expend it later.
      ...
      \psionicList{Matter Rearrangement}\textsuperscript{P}: Change one object's fundamental properties.
...
\begin{enumerate*}
\item \psionicList{Astral Projection, Personal}: Create a clone in the Astral Plane.
...
\item \psionicList{Dimension Blade}\textsuperscript{P}: Transform a melee weapon into a super sharp blade.
      ...
      \psionicList{Time Hop, Personal}\textsuperscript{A}: You hop forward up to 3 rounds in the future.

\item \psionicList{Astral Projection, Psionic}\textsuperscript{A}: You lead a group to a planar destination.
...
\item \psionicList{Teleport, Psionic}\textsuperscript{A}: Instantly transports you as far as 90,000 km.
      ...
      \psionicList{Time Dilation}\textsuperscript{AP}: Speed up or slow down your time frame.
...
\item \psionicList{Banishment, Psionic}: Teleport a creature to a pocket dimension.
      ...
      \psionicList{Ethereal Jaunt, Psionic}: Become ethereal for a short period.

      \psionicList{Time Hop}\textsuperscript{AP}: As \psionic{personal time hop}, but affects an unwilling subject.

\item \psionicList{Decerebrate}\textsuperscript{P}: Remove portion of subject's brain stem.

      \psionicList{Phase Object}\textsuperscript{P}: Make an object ethereal for a short period.

      \psionicList{Summon Planar Creature}\textsuperscript{AP}: Transport one creature from another plane to you.

\item \psionicList{Planar Energy}\textsuperscript{P}: Transport harmful energy from an Inner Plane.
...
\item \psionicList{Planar Transportation}\textsuperscript{AP}: Switch a 9-meter-cube from one plane for a portion of another plane.
      ...
      \psionicList{Time Regression}\textsuperscript{PX}: Rewind the time flow by 1 round.
\end{enumerate*}
...
\item \psionicList{Clairaudience}: Hear at a distance.
      ...
      \psionicList{Detect Magic, Psionic}: Detects spells and magic items within 6 m.

      \psionicList{Detect Material}: Detects specified substance or item within 27 m.

      \psionicList{See Etherealness}: Reveal ethereal creatures or objects.
...
\item \psionicList{Clairvoyance}: See at a distance.
      ...
      \psionicList{Incarnation Awareness}: Detect how many times the target has been revived.
...
\item \psionicList{Cannibalize}\textsuperscript{P}: Convert your Constitution score into power points.
      ...
      \psionicList{Heighten Senses}\textsuperscript{AP}: You improve all your five senses.

      \psionicList{Hivemind}\textsuperscript{P}: Gain power points from nearby insects.

      \psionicList{Trance}\textsuperscript{AP}: Gain bonus depending on the type of trance.

\item \psionicList{Aura Alteration}\textsuperscript{P}: Repairs psyche or makes subject seem to be something it is not. %XPH

      \psionicList{Bestow Power}\textsuperscript{AP}: Subject receives 8 power points. %XPH

      \psionicList{Detect Psionics}\textsuperscript{P}: You detect the presence of psionics.

      \psionicList{Feat Leech}\textsuperscript{AP}: Borrow another's psionic or metapsionic feats. %XPH

      % \psionicList{Identify, Psionic}: Learn the properties of a psionic item.

      \psionicList{Probability Manipulation}\textsuperscript{P}: Gain advantage on your next roll.

      \psionicList{Teleport Trigger}\textsuperscript{P}: Predetermined event triggers \psionic{psionic teleport}. %XPH

\item \psionicList{Power Residue}\textsuperscript{P}: Collect power points from the powers used in the last five rounds.

      \psionicList{Trace Teleport}\textsuperscript{AP}: Learn destination of subject's \emph{teleport}. %XPH

\item \psionicList{Divination, Psionic}\textsuperscript{P}: Provides useful advice for specific proposed action.

      \psionicList{Freedom of Movement, Psionic}\textsuperscript{P}: You cannot be held or otherwise rendered immobile.

      \psionicList{Mindlink, Thieving}\textsuperscript{P}: Borrow knowledge of a subject's power.
...
\item \psionicList{Antimagic Field, Psionic}\textsuperscript{P}: Suppress all magic in a 9-meter radius.
      ...
      \psionicList{Metaconcert}\textsuperscript{AP}: Mental concert of two or more increases the total power of the participants. %XPH

      \psionicList{Power Leech}\textsuperscript{AP}: Drain power points while you maintain concentration. %XPH

      \psionicList{Shield Other, Psionic}\textsuperscript{P}: You take half of subject's damage.

\item \psionicList{Null Psionics Field}\textsuperscript{P}: Create a field where psionic power does not function. %XPH

\item \psionicList{Power Leech, Mass}\textsuperscript{AP}: Drain power points while you maintain concentration.

      \psionicList{Psychic Chirurgery}\textsuperscript{PX}: You repair psychic damage or impart knowledge of new powers. %XPH
...
\item \psionicList{Bend Reality}\textsuperscript{PX}: Alters reality within power limits. %XPH
      ...
      \psionicList{Fission}\textsuperscript{P}: You briefly duplicate yourself. %XPH
...
\item \psionicList{Apopsi}\textsuperscript{PX}: You delete target's psionic powers. %XPH
      ...
      % \psionicList{Genesis}\textsuperscript{PX}: You instigate a new demiplane on the Astral Plane. %XPH
      ...
      \psionicList{Seance}\textsuperscript{P}: Multiple participants ask questions from the memory of other minds.

      \psionicList{Ultrablast}\textsuperscript{P}: Subjects in area become unconscious and lose all psionic powers.
\end{enumerate*}
...
\item \psionicList{Conceal Thoughts}: Protects you mind against telepathic powers.
      ...
      \psionicList{Daze, Psionic}: Target loses next action.

      \psionicList{Psychic Crush}\textsuperscript{AP}: Telepathic attack. Deal 2d8 points of damage.

      \psionicList{Send Thoughts}\textsuperscript{P}: Make a one-way communication with the target.

      \psionicList{Suppress Fear}: Remove any fear effect on subject, or give advantage to their next save.

      \psionicList{True Worship}: Detect the subject's focus of worship.

      \psionicList{Truthear}: Automatically pass in \skill{Sense Motive} checks.

\item \psionicList{Blindness/Deafness, Psionic}:\textsuperscript{P}: Makes subject blinded or deafened.
...
\item \psionicList{Awe}\textsuperscript{P}: Subject fears you.
      ...
      \psionicList{Detect Life}\textsuperscript{A}: Detect presence of thinking creatures in a 54-meter cone.

      \psionicList{Ego Whip}\textsuperscript{AP}: Telepathic attack. Leave target shaken for 1d4 rounds. Spellcasters cannot cast spells above 3rd level.

      \psionicList{Ejection}: Force unwanted \emph{contacts} out of your mind, with risk of side effects.

      \psionicList{False Sensory Input}\textsuperscript{P}: Subject sees what isn't there.

      \psionicList{Major Image, Psionic}\textsuperscript{P}: As \spell{major image}, but for one target.

      \psionicList{Psychic Messenger}\textsuperscript{P}: Create a image of yourself to deliver a message within 300 km.

      \psionicList{Read Thoughts}\textsuperscript{P}: Detect surface thoughts of a \emph{contacted} mind.
...
\item \psionicList{Attraction}\textsuperscript{P}: Subject has attraction you specify.
      ...
      \psionicList{Fear, Psionic}\textsuperscript{P}: Subject flees while you maintain the power.

      \psionicList{Mind Bar}: You become immune to possession and gain +15 bonus on Will saves against mind-affecting effects.
...
\item \psionicList{Dominate, Psionic}\textsuperscript{AP}: Control target telepathically.
      ...
      \psionicList{Invisibility, Superior}\textsuperscript{P}: As \psionic{psionic invisibility}, but creatures have no sound or smell.
...
\item \psionicList{Dominate, Mass}\textsuperscript{AP}: As \psionic{dominate}, but up to five targets.

      \psionicList{Mind Blank, Personal}\textsuperscript{P}: You are immune to scrying and mental effects for one day.

      \psionicList{Mind Switch}\textsuperscript{PX}: You switch minds with another.
...
\item \psionicList{Mind Blank, Psionic}\textsuperscript{P}: Subject immune to mental/emotional effects and scrying effects for one day.
      ...
      \psionicList{Mindwipe}\textsuperscript{P}: Target gains one negative level and takes 1 point of Int and Wis damage per round.
