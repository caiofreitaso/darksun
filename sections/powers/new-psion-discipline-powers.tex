...
\item \psionicList{Trace Teleport}\textsuperscript{AP}: Learn destination of subject's \emph{teleport}. %XPH
...
\item \psionicList{Charm, Psionic}\textsuperscript{AP}: Makes one person your friend.
