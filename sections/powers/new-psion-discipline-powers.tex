...
\item \psionicList{Predestination}\textsuperscript{P}: Predict the destiny of a single creature.
...
\item \psionicList{Detect Psionics}\textsuperscript{P}: You detect the presence of psionics.
      ...
      \psionicList{Teleport Trigger}\textsuperscript{P}: Predetermined event triggers teleport.
