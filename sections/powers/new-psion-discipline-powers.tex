...
\item
\item
\item \psionicList{Create Object}\textsuperscript{P}: Assemble matter from the surrounding area to create a solid object.
\item \psionicList{Detonate}\textsuperscript{P}: Explode small objects or destroy one construct or undead creature.
\item
\item \psionicList{Disintegrate, Psionic}\textsuperscript{P}: Explode small objects or destroy one construct, plant, or undead creature.
\item
\item
\end{enumerate*}
