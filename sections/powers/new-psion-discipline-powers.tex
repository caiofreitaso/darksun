...
\item \psionicList{Mindlink}\textsuperscript{P}: You forge a limited mental bond with a \emph{contacted} creature.

      \psionicList{Psionic Blast}\textsuperscript{AP}: Telepathic attack. Deal 80\% of the target's hit points as non-lethal damage.

\item \psionicList{Id Insinuation}\textsuperscript{AP}: Telepathic attack. Daze target for 1d4 rounds.
