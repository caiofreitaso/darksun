...
\item \psionicList{Dimensional Screen}\textsuperscript{P}: Wrap yourself with a \psionic{psionic dimension door}.

      \psionicList{Null Psionics Field}\textsuperscript{P}: Create a field where psionic power does not function. %XPH
...
\begin{enumerate*}
\item \psionicList{Contact}: Establish mental connection with the target's mind.
\item \psionicList{Mind Thrust}\textsuperscript{A}: Telepathic attack. Lock one of the target's known psionic powers for 2d6 days.
\item \psionicList{Ego Whip}\textsuperscript{A}: Telepathic attack. Daze and shaken target for 1d4 rounds. Spellcasters cannot cast spells above 3rd level.
\item \psionicList{Id Insinuation}\textsuperscript{A}: Telepathic attack. Daze target for 1d4 rounds.

\psionicList{Psychic Crush}\textsuperscript{A}: Telepathic attack. Deal 1d8 points of damage.
\item \psionicList{Psionic Blast}\textsuperscript{A}: Telepathic attack. Deal 80\% of the target's hit points as non-lethal damage. Wears off after six turns.
\item
\item
\item
\item
