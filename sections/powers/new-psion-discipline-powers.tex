...
\item \psionicList{Read Thoughts}\textsuperscript{P}: Read someone's surface thoughts.

      \psionicList{Mind Thrust}\textsuperscript{A}: Telepathic attack. Lock one of the target's known psionic powers for 2d6 days.
...
\item \psionicList{Probe}\textsuperscript{P}: Telepathically ask one question/round to a target.

      \psionicList{Psionic Blast}\textsuperscript{A}: Telepathic attack. Deal 80\% of the target's hit points as non-lethal damage. Wears off after six turns.
