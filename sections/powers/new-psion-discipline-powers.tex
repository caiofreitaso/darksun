...
\item \psionicList{Aging}: Victim ages 2d4 years.
      ...
      \psionicList{Enhance Strength}: Turn your Strength score to 18.

      \psionicList{Enhance Dexterity}: Turn your Dexterity score to 18.
...
\item \psionicList{Bestow Power}\textsuperscript{AP}: Subject receives 8 power points. %XPH
      ...
      \psionicList{Probability Manipulation}: Gain advantage on your next roll.
...
\item \psionicList{Aura Alteration}\textsuperscript{P}: Makes subject seem to be something it is not.

      \psionicList{Blindness/Deafness, Psionic}:\textsuperscript{P}: Makes subject blinded or deafened.
