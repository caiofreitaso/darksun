...
Spirit initiate & Multiclass druid/manifester that slowly melds into a spirit of the land \\
}


\newcommand{\EpicTable}[3][ll *{3}{Z{5mm}} L Z{16mm}]{
    \BigTableBottom{#2}{#1}{
          \tableheader Level
        ...
        & \tableheader Special
        & \tableheader Psionic Enchantments\\
        #3
    }
}
