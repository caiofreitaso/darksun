...
\newcommand{\PsiEnch}{\PowerDescription[\subsubsection]{psiench}}
...
\subsubsection{Silt}
\psienchList{Dry Out}: Turn a body of water into silt. %NEW

\psienchList{Horrid Wilting, Mass}: As \spell{horrid wilting}, affects one subject/level. %NEW
...
\psienchList{Dawn}: Shorten the duration of the night. %NEW

\psienchList{Solar Ray}: Focus all light from the sun into a single point. %NEW
...
\psienchList{Genesis}\textsuperscript{X}: Create a demiplane. %NEW


\subsection{Psionic Enchantment Descriptions}

\PsiEnch{Air of Permanence}{air of permanence}
{Transmutation [Air]}
{
    \textbf{Level:}
    Air 10, Drd 10\\
...
\PsiEnch{Change of Heart}{change of heart}
