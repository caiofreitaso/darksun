...
\psienchList{Air of Permanence}\textsuperscript{\bfseries Air}: Make an item immune to aging.

\psienchList{Alter Climate}\textsuperscript{\bfseries Air, Water}: Make an item immune to aging.

\psienchList{Change of Heart}: Change target's alignment.

\psienchList{Create Oasis}\textsuperscript{\bfseries Earth, Water}: Create an oasis within a stone circle.
...
\psienchList{Silt Bridge}\textsuperscript{\bfseries Earth, Silt}: Solidify huge portions of silt.

\psienchList{Storm Legion}\textsuperscript{\bfseries Air, Rain, Water}: Transports willing creatures via a natural storm.

\psienchList{Wall of Mountains}\textsuperscript{\bfseries Earth}: Create a mountain range for one day.

\psienchList{Wild Weather}\textsuperscript{\bfseries Air, Rain, Water}: As \spell{control weather}, but all weather is possible.
...
\psienchList{Dome of Invulnerability}: As \spell{globe of invulnerability}, but affects a larger area.

\psienchList{Dimensional Lock, Epic}: As \spell{dimensional lock}, but affects a settlement. %NEW
...
\psienchList{Prolific Vegetation}\textsuperscript{1}: Instan shrubs and grass
...
\psienchList{Dominate Monster, Mass}: As \spell{dominate monster}, but all within 9 m. %NEW
