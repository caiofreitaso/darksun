...
\input{subsections/spells/awaken-water-spirits.tex}
\input{subsections/spells/backlash.tex}
\input{subsections/spells/baleful-polymorph.tex}
\input{subsections/spells/bane.tex}
\input{subsections/spells/banish-tyr-storm.tex} %DS3
\input{subsections/spells/banishment.tex}
\input{subsections/spells/barkskin.tex}
\input{subsections/spells/battlefield-healing.tex} %DS3
...
\input{subsections/spells/black-cairn.tex} %DS3
...
\input{subsections/spells/blazing-wreath.tex} %DS3
\input{subsections/spells/bless.tex}
	%% \input{subsections/spells/bless-water.tex}
\input{subsections/spells/bless-element.tex} %DS3
...
\input{subsections/spells/blindscorch.tex} %DS3
...
\input{subsections/spells/boneclaw-s-cut.tex} %DS3
\input{subsections/spells/boneharden.tex} %DS3
\input{subsections/spells/brain-spider.tex}
\input{subsections/spells/braxatskin.tex} %DS3
...
\input{subsections/spells/cerulean-hail.tex} %DS3
\input{subsections/spells/cerulean-shock.tex} %DS3
...
\input{subsections/spells/claws-of-the-tembo.tex} %DS3
\input{subsections/spells/cleansing-flame.tex} %DS3
\input{subsections/spells/clear-river.tex} %DS3
\input{subsections/spells/clear-water.tex} %DS3
\input{subsections/spells/clenched-fist.tex}
\input{subsections/spells/cloak-of-chaos.tex}
\input{subsections/spells/clone.tex}
\input{subsections/spells/clues-of-ash.tex} %DS3
\input{subsections/spells/cloudkill.tex}
\input{subsections/spells/coat-of-mists.tex} %DS3
...
\input{subsections/spells/confessors-flame.tex} %DS3
\input{subsections/spells/conflagration.tex} %DS3
\input{subsections/spells/confusion-lesser.tex}
\input{subsections/spells/confusion.tex}

\BigTableBottom{Contact Other Plane}{Xl*{4}{Z{19mm}}}{
...
\input{subsections/spells/conservation.tex} %DS3
...
\input{subsections/spells/control-tides.tex} %DS3
...
\input{subsections/spells/conversion.tex} %DS3
\input{subsections/spells/cooling-canopy.tex} %DS3
\input{subsections/spells/create-element.tex} %DS3
\input{subsections/spells/create-food-and-water.tex}
\input{subsections/spells/create-greater-undead.tex}
\input{subsections/spells/create-oasis.tex} %DS3
...
\input{subsections/spells/crusade.tex} %DS3
...
\input{subsections/spells/curse-element.tex} %DS3
\input{subsections/spells/curse-of-the-black-sands.tex} %DS3
\input{subsections/spells/curse-of-the-choking-sands.tex} %DS3
...
\input{subsections/spells/death-mark.tex} %DS3
\input{subsections/spells/death-ward.tex}
\input{subsections/spells/death-whip.tex} %DS3
\input{subsections/spells/deathwatch.tex}
\input{subsections/spells/dedication.tex} %DS3
\input{subsections/spells/deep-slumber.tex}
\input{subsections/spells/deeper-darkness.tex}
\input{subsections/spells/defiler-scent.tex} %DS3
...
\BigTableBottom{Detect Evil Aura Power}{lCCCC}{
...
\BigTableBottom{Detect Magic Aura Power}{lCCCC}{
& \multicolumn{4}{c}{\tableheader Aura Power}\\
\cmidrule[0.5pt]{2-5}
\tableheader Creature/Object & \tableheader Faint & \tableheader Moderate & \tableheader Strong & \tableheader Overwhelming\\
...
\input{subsections/spells/drown-on-dry-land.tex} %DS3
...
\input{subsections/spells/echo-of-the-lirr.tex} %DS3
\input{subsections/spells/elemental-armor.tex} %DS3
\input{subsections/spells/elemental-chariot.tex} %DS3
\input{subsections/spells/elemental-chariot-greater.tex} %DS3
\input{subsections/spells/elemental-swarm.tex}
\input{subsections/spells/elemental-weapon.tex} %DS3
...
\input{subsections/spells/eye-of-the-storm.tex} %DS3
...
\input{subsections/spells/fire-track.tex} %DS3
...
\BigTableBottom{Prismatic Wall Effects}{lcXl}{
...
\input{subsections/spells/slave-scent.tex} %DS3
...
\BigTable{Summon Monster}{XXX}{
\tableheader 1st-level                      & \tableheader 4th-level                              & \tableheader 7th-level \\
Air-touched hawk                            & Air-touched giant owl                               & Arrowhawk, elder \\
Air-touched owl                             & Black-touched bog wader                             & Black-touched dark spider defiler \\
Black-touched dustgull                      & Earth-touched lion                                  & Black-touched tembo \\
Earth-touched jankx                         & Fire-touched lirr                                   & Djinni (genie) \\
Fire-touched dire rat                       & Gray-touched pterrax                                & Earth-touched slimahacc \\
Fire-touched giant fire beetle              & Magma-touched monstrous spider, Large               & Elemental, Huge (any) \\
Gray-touched sandcrawler                    & Mephit (any)                                        & Gray-touched cilops \\
Magma-touched monstrous centipede, Medium   & Shadow                                              & Gray-touched hatori \\
Magma-touched monstrous scorpion, Small     & Silt-touched snake, Huge viper                      & Invisible stalker \\
Rain-touched skyfish\footnotemark[1]        & Sun-touched giant wasp                              & Magma-touched monstrous scorpion, Huge \\
Silt-touched monstrous spider, Small        & Thoqqua                                             & Sand Bride \\
Silt-touched snake, Small viper             & Water-touched athasian shark, Large\footnotemark[1] & Water-touched giant octopus\footnotemark[1] \\
Sun-touched monkey                          & Xorn, minor                                         & \\
Water-touched octopus\footnotemark[1]       &                                                     & \\
...
\BigTableNote{3}{1 The creature may only be summoned into an aquatic environment.}\\
\BigTableNote{3}{2 The creature may only be summoned into a silt-rich environment.}\\
\BigTableNote{3}{3 The creature may only be summoned into an abundant environment.}\\
}
