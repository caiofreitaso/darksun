...
\spellList{Defiler Scent}\textsuperscript{R}: Smells the presence or absence of defilers. %%

\spellList{Detect Magic}\textsuperscript{R}: Detects spells and magic items within 18 m.

\spellList{Detect Poison}\textsuperscript{R}: Detects poison in one creature or object.
...
\spellList{Know Direction}\textsuperscript{R}: You discern north.
...
\spellList{Detect Animals or Plants}\textsuperscript{R}: Detects kinds of animals or plants.

\spellList{Detect Snares and Pits}\textsuperscript{R}: Reveals natural or primitive traps.

\spellList{Detect Undead}\textsuperscript{R}: Reveals undead within 18 meters.
...
\spellList{Plant Renewal}\textsuperscript{R}: Brings one plant back from near destruction.
...
\spellList{Speak with Animals}\textsuperscript{R}: You can communicate with animals.
...
\spellList{Meld into Stone}\textsuperscript{R}: You and your gear merge with stone.
...
\spellList{Quench}\textsuperscript{R}: Extinguishes nonmagical fires or one magic item.
...
\spellList{Reincarnate}\textsuperscript{MR}: Brings dead subject back in a random body.
...
\spellList{Commune with Nature}\textsuperscript{R}: Learn about terrain for 1.5 kilometer/level.

\spellList{Control Winds}: Change wind direction and speed.

\spellList{Conversion}\textsuperscript{FXR}: Removes burden of acts of defiling from a wizard.
...
\spellList{Rejuvenate}\textsuperscript{R}: Increase the fertility of the land.
