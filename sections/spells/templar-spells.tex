...
\spellList{Defiler Scent}\textsuperscript{R}: Smells presence or absence of defilers.

\spellList{Detect Magic}\textsuperscript{R}: Detects spells and magical items within 18 m.
...
\spellList{Comprehend Languages}\textsuperscript{R}: Understand all spoken and written languages.
...
\noindent\textit{\hyperref[spell:Protection from Evil]{Protection from Evil}/\hyperref[spell:Protection from Good]{Good}}: +2 to AC and saves, counter mind control, hedge out elementals and outsiders.
...
\spellList{Footsteps of the Quarry}\textsuperscript{MR}: Track a specific creature or person.
...
\noindent\textit{\hyperref[spell:Magic Circle against Evil]{Magic Circle against Evil}/\hyperref[spell:Magic Circle against Good]{Good}}: As \emph{protection} spells, but 3-m radius and 10 min./level.
