...
\spellList{Silence}: Negates sound in 15-ft radius.
...
\spellList{Magic Circle against Evil/Good}: As protection spells, but 3-m radius and 10 min./level.
...
\spellList{Dispel Magic, Greater}: As dispel magic, but up to +20 on check.

\spellList{Forbiddance}: Denies area to creatures of another alignment.
