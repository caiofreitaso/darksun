...
\subsubsection{Divination}
	\spellList{Detect Poison}\textsuperscript{R}: Detects poison in one creature or small object.
...
\subsubsection{Transmutation}
	\spellList{Mage Hand}\textsuperscript{R}: 2-kg telekinesis.

	\spellList{Mending}: Makes minor repairs on an object.

	\spellList{Message}\textsuperscript{R}: Whispered conversation at distance.

	\spellList{Open/Close}: Opens or closes small or light things.

\subsubsection{Universal}
	\spellList{Arcane Mark}\textsuperscript{R}: Inscribes a personal rune (visible or invisible).

	\spellList{Prestidigitation}\textsuperscript{R}: Performs minor tricks.
...
\subsubsection{Abjuration}
	\spellList{Alarm}\textsuperscript{R}: Wards an area for 2 hours/level.
...
\subsubsection{Conjuration}
	...
	\spellList{Unseen Servant}\textsuperscript{R}: Invisible force obeys your commands.
...
\subsubsection{Divination}
	...
	\spellList{Identify}\textsuperscript{MR}: Determines properties of magic item.
...
\subsubsection{Evocation}
	...
	\spellList{Floating Disk}\textsuperscript{R}: Creates 1-m-diameter horizontal disk that holds 50 kg/level.
...
\subsubsection{Illusion}
	...
	\spellList{Magic Aura}\textsuperscript{R}: Alters object's magic aura.
...
\subsubsection{Transmutation}
	...
	\spellList{Erase}\textsuperscript{R}: Mundane or magical writing vanishes.
...
\subsubsection{Abjuration}
	\spellList{Arcane Lock}\textsuperscript{MR}: Magically locks a portal or chest.

	\spellList{Backlash}: 1d6+1 damage/2 levels to defilers. %%

	\spellList{Eye of the Storm}\textsuperscript{R}: Protects 9-m radius from effects of storm for 1 hour/level.%%
...
\subsubsection{Divination}
	...
	\spellList{Footsteps of the Quarry}\textsuperscript{R}: Track a specific creature or person. %%

	\spellList{Locate Object}\textsuperscript{R}: Senses direction toward object (specific or type).
...
\subsubsection{Illusion}
	...
	\spellList{Magic Mouth}\textsuperscript{MR}: Speaks once when triggered.
	...
	\spellList{Phantom Trap}\textsuperscript{MR}: Makes item seem trapped.
...
\subsubsection{Transmutation}
	...
	\spellList{Whispering Wind}\textsuperscript{R}: Sends a short message 1.5 kg/level.
...
\subsubsection{Abjuration}
	\spellList{Conservation}\textsuperscript{MR}: Protect the land from defilement. %%
	...
	\spellList{Nondetection}\textsuperscript{MR}: Hides subject from divination, scrying.

	\spellList{Protection from Energy}: Absorb 12 points/level of damage from one kind of energy.

\subsubsection{Conjuration}
	\spellList{Phantom Steed}\textsuperscript{R}: Magic horse appears for 1 hour/level.

	\spellList{Sepia Snake Sigil}\textsuperscript{MR}: Creates text symbol that immobilizes reader.
...
\subsubsection{Illusion}
	...
	\spellList{Illusory Script}\textsuperscript{MR}: Only intended reader can decipher.
...
\subsubsection{Necromancy}
	...
	\spellList{Gentle Repose}\textsuperscript{R}: Preserves one corpse.
...
\subsubsection{Transmutation}
	...
	\spellList{Secret Page}\textsuperscript{R}: Changes one page to hide its real content.
	...
	\spellList{Worm's Breath}\textsuperscript{R}: Subjects can breathe underwater, in silt or earth. %%
...
\subsubsection{Evocation}
	\spellList{Dweomer of Transference}\textsuperscript{R}: Convert spellcasting into psionic power points.
...
\subsubsection{Divination}
	...
	\spellList{Telepathic Bond}\textsuperscript{R}: Link lets allies communicate.
...
\subsubsection{Evocation}
	...
	\spellList{Sending}\textsuperscript{R}: Delivers short message anywhere, instantly.
...
\subsubsection{Universal}
	\spellList{Permanency}\textsuperscript{XR}: Makes certain spells permanent.
...
\subsubsection{Abjuration}
	...
	\spellList{Guards and Wards}\textsuperscript{R}: Array of magic effects protect area.
...
\subsubsection{Divination}
	\spellList{Analyze Dweomer}\textsuperscript{FR}: Reveals magical aspects of subject.

	\spellList{Legend Lore}\textsuperscript{MFR}: Lets you learn tales about a person, place, or thing.
...
\subsubsection{Illusion}
	...
	\spellList{Permanent Image}\textsuperscript{MR}: Includes sight, sound, and smell.
