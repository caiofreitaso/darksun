...
Skill checks represent nonviolent challenges in the game. Whenever a character makes a successful skill check, calculate the adjusted Difficulty Class (DC) of the check. It is equal to the skill check's DC minus any racial bonus the character has in that check. Use \tabref{Experience Awards from Skill Checks} to find the XP award. An adjusted DC lower than 10 does not warrant experience points. The award is not based on the check's result.
...
\Table{Experience Awards from Skill Checks}{*4C}{
\tableheader Adjusted DC & \tableheader XP Award
& \tableheader Adjusted DC & \tableheader XP Award\\
10--11 & 10 XP & 25--29 & 200 XP\\
12--14 & 25 XP & 30--39 & 350 XP\\
15--19 & 50 XP & 40--49 & 500 XP\\
20--24 & 100 XP & 50+ & 750 XP\\
}

\subsubsection{Awards for Combat}
Each pace of campaign has a different award---faster campaigns have bigger rewards. To determine the XP award for a combat, follow these steps.
\begin{enumerate*}
