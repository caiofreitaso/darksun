...
\begin{figure}[t!]
\centering
\includegraphics[width=\columnwidth]{images/psion-3.png}
\end{figure}
...
\textit{Telepathic Speech (Ex):} If the owner is 5th level or higher, the psicrystal can communicate telepathically with any creature that has a language and is within 9 meters of the psicrystal, while the psicrystal is also within 1 mile of the owner.
