...
% 7th  & +5         & +5  & +2 & +5  & Combined casting            & 6 & 4+1 & 3+1 & 2+1 & 1+1 &  &  &  &  &  \\
...
7th  & +5         & +5  & +2 & +5  & Combined casting            & 3 & 2+1 & 2+1 & 2+1 & 1+1 &     &     &     &     &     \\
8th  & +6/+1      & +6  & +2 & +6  &                             & 3 & 2+1 & 2+1 & 2+1 & 2+1 &     &     &     &     &     \\
9th  & +6/+1      & +6  & +3 & +6  &                             & 3 & 2+1 & 2+1 & 2+1 & 2+1 & 1+1 &     &     &     &     \\
10th & +7/+2      & +7  & +3 & +7  & Bonus feat                  & 3 & 2+1 & 2+1 & 2+1 & 2+1 & 2+1 &     &     &     &     \\
...
15th & +11/+6/+1  & +9  & +5 & +9  & Bonus feat                  & 3 & 2+1 & 2+1 & 2+1 & 2+1 & 2+1 & 2+1 & 2+1 & 1+1 &     \\
...
\textbf{Sacrifice (Su):} Beginning at 5th level, a cleric can take defiling damage instead of the land, when he is close to a wizard when they are defiling. The cleric must be within a distance to the wizard equal to twice the defiling radius of the spell being cast. The cleric takes 2 points of damage per spell level and he nullifies the defiling radius and its effects. For more information on defiling, see \chapref{Magic}.
...
\textbf{Combined Casting (Su):} Beginning at 7th level, an elemental cleric can join forces with another elemental cleric to cast a spell from a paraelemental domain. This special casting cannot be done by paralemental clerics. For more information on combined casting, see \chapref{Magic}.

\textbf{Bonus Feat:} At 10th level and every five levels thereafter (15th and 20th level), a cleric gains a bonus feat related to his element or paraelement. He may select a divine feat\textsuperscript{CD}, a domain feat\textsuperscript{CC}, \feat{Extra Turning}, or \feat{Improved Turning}. He must meet all the prerequisites for the feat.

\textit{Domain Equivalencies:} Most clerical domains do not have a related domain feat\textsuperscript{CC}, so \tabref{Domain Equivalencies} provides equivalencies for those domains.

\Table{Domain Equivalencies}{XX}{
  \tableheader Domain
& \tableheader Equivalent Domain Feat \\
Agriculture   & Plant Devotion\textsuperscript{CC} \\
Cleansing     & Strength Devotion\textsuperscript{CC} \\
Cycle         & Death Devotion\textsuperscript{CC} \\
Decay         & Destruction Devotion\textsuperscript{CC} \\
Drought       & Death Devotion\textsuperscript{CC} \\
Forecasting   & Air Devotion\textsuperscript{CC} \\
Freedom       & Luck Devotion\textsuperscript{CC} \\
Growth        & Animal Devotion\textsuperscript{CC} \\
Magma         & Fire Devotion\textsuperscript{CC} \\
Mirage        & Trickery Devotion\textsuperscript{CC} \\
Purity        & Protection Devotion\textsuperscript{CC} \\
Rain          & Water Devotion\textsuperscript{CC} \\
Replenishment & Healing Devotion\textsuperscript{CC} \\
Silt          & Earth Devotion\textsuperscript{CC} \\
Wrath         & War Devotion\textsuperscript{CC} \\
}
