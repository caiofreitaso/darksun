...
\textit{Domain Equivalencies:} Most clerical domains do not have a related domain feat\textsuperscript{CC}, so the following table provides equivalencies for those domains.
