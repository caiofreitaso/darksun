...
\BigTableBottom{The Gladiator}{ll *3{Z{5mm}} Z{9mm} L}{
  \tableheader Level
& \tableheader Base Attack Bonus
& \tableheader Fort Save
& \tableheader Ref Save
& \tableheader Will Save
& \tableheader Unarmed Damage
& \tableheader Special\\
1st  & +1             & +2  & +0 & +0 & 1d6  & Flurry of blows, unarmed strike, arena performance, dirty trick $\pm2$/$\pm4$ \\
2nd  & +2             & +3  & +0 & +0 & 1d6  & Bonus feat, exotic weapon                                                     \\
3rd  & +3             & +3  & +1 & +1 & 1d6  & Bonus feat, exotic aptitude, taunt                                            \\
4th  & +4             & +4  & +1 & +1 & 1d6  & Martial prowess, uncanny dodge                                                \\
5th  & +5             & +4  & +1 & +1 & 1d8  & Armor optimization 1, \feat{Improved Feint}                                   \\
6th  & +6/+1          & +5  & +2 & +2 & 1d8  & Exotic weapon, parry, bleeding strike                                         \\
7th  & +7/+2          & +5  & +2 & +2 & 1d8  & Bonus feat, martial prowess, dirty trick $\pm3$/$\pm5$                        \\
8th  & +8/+3          & +6  & +2 & +2 & 1d8  & Improved uncanny dodge, mercy                                                 \\
9th  & +9/+4          & +6  & +3 & +3 & 1d8  & Debilitating strike                                                           \\
10th & +10/+5         & +7  & +3 & +3 & 1d10 & Armor optimization 2, exotic weapon, martial prowess                          \\
11th & +11/+6/+1      & +7  & +3 & +3 & 1d10 &                                                                               \\
12th & +12/+7/+2      & +8  & +4 & +4 & 1d10 & \emph{Pounce}                                                                 \\
13th & +13/+8/+3      & +8  & +4 & +4 & 1d10 & Martial prowess, dirty trick $\pm4$/$\pm6$                                    \\
14th & +14/+9/+4      & +9  & +4 & +4 & 1d10 & Exotic weapon                                                                 \\
15th & +15/+10/+5     & +9  & +5 & +5 & 1d12 & Armor optimization 3, \emph{hustle}                                           \\
...
\textit{Dirty Trick (Ex):} A gladiator with 3 or more ranks in \skill{Perform} (arena fighting) can use his arena guile to get an advantage over his enemies. A gladiator can use a dirty trick to do one of the following:
...
A dirty trick lasts for 5 rounds. The opponent must be within the gladiator's threatened area. A gladiator can use each option of dirty trick once per encounter per opponent, but a gladiator may never repeat the same option against the same enemy or use it more than once in a single round against the same enemy.
...
A gladiator also deals more damage with his unarmed strikes than a normal person would, as shown on \tabref{Small or Large Gladiator Unarmed Damage}.

\Table{Small or Large Gladiator Unarmed Damage}{lCC}{
& \multicolumn{2}{c}{\tableheader Unarmed Damage}\\
\cmidrule[0.5pt]{2-3}
  \tableheader Level
& \tableheader Small Gladiator
& \tableheader Large Gladiator\\
 1st--4th  & 1d4  & 1d8 \\
 5th--9th  & 1d6  & 2d6 \\
10th--14th & 1d8  & 2d8 \\
15th--20th & 1d10 & 3d6 \\
