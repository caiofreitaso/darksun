...
1 & +1 & +2 & +0 & +0 & \feat{Improved Unarmed Strike}, gladiatorial performance, dirty trick +1/$-1$\\
...
6 & +6/+1 & +5 & +2 & +2 & Exotic weapon, parry\\
7 & +7/+2 & +5 & +2 & +2 & Bonus feat, dirty trick +2/$-2$, stance (shorten haft, threatening glare, defensive stance) \\
8 & +8/+3 & +6 & +2 & +2 & Improved uncanny dodge, mercy \\
9 & +9/+4 & +6 & +3 & +3 & \feat{Leadership}, shake off \\
10 & +10/+5 & +7 & +3 & +3 & Armor optimization 2, exotic weapon \\
11 & +11/+6/+1 & +7 & +3 & +3 & Improved parry \\
12 & +12/+7/+2 & +8 & +4 & +4 & Pounce, stance (keen eye, scoundrel pose) \\
13 & +13/+8/+3 & +8 & +4 & +4 & Dirty trick +3/$-3$, greater feint \\
14 & +14/+9/+4 & +9 & +4 & +4 & Exotic weapon \\
15 & +15/+10/+5 & +9 & +5 & +5 & Armor optimization 3, dragon's fury \\
16 & +16/+11/+6/+1 & +10 & +5 & +5 & Greater parry \\
17 & +17/+12/+7/+2 & +10 & +5 & +5 & Stance (mindless focus) \\
18 & +18/+13/+8/+3 & +11 & +6 & +6 & Exotic weapon \\
...
\skill{Balance} (Dex), \skill{Bluff} (Cha), \skill{Climb} (Str), \skill{Craft} (Int), \skill{Intimidate} (Cha), \skill{Jump} (Str), \skill{Perform} (Cha), \skill{Profession} (Wis), \skill{Ride} (Dex), \skill{Sense Motive} (Wis), \skill{Spot} (Wis), \skill{Tumble} (Dex).
...
\textbf{Gladiatorial Performance:} Once per day per gladiator level, you can use your talents to affect enemies and allies. Each ability requires both a minimum gladiator level and a minimum number of ranks in the \skill{Perform} (arena fighting) skill to qualify.

Starting a gladiatorial performance effect is a move action unless otherwise stated. Some effects require concentration, which means you must take a standard action each round to maintain the ability.
...
\textbf{Improved Unarmed Strike:} A gladiator gains \feat{Improved Unarmed Strike} as a bonus feat.
...
\textbf{Bonus Feat:} At 2nd level, a gladiator may select either \feat{Blind-Fight} or \feat{Endurance} as bonus feat. At 3rd level, a gladiator may select either \feat{Combat Expertise} or \feat{Mounted Combat} as bonus feat. At 7th level, a gladiator may select one of \feat{Improved Bull Rush}, \feat{Improved Disarm}, \feat{Improved Grapple}, \feat{Improved Overrun}, \feat{Improved Sunder}, or \feat{Improved Trip}. A gladiator need not have any of the prerequisites normally required for these feats to select them.
