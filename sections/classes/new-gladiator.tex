...
1 & +1 & +2 & +0 & +0 & Exotic weapon, mercy, gladiatorial performance, stance (defensive), martial display, taunt -1\\
2 & +2 & +3 & +0 & +0 & Bonus feat, stance (arena guile) \\
3 & +3 & +3 & +1 & +1 & Bonus feat\\
4 & +4 & +4 & +1 & +1 & Uncanny dodge \\
5 & +5 & +4 & +1 & +1 & Exotic weapon \\
6 & +6/+1 & +5 & +2 & +2 & Shake off, stance (elvish) \\
7 & +7/+2 & +5 & +2 & +2 & \\
