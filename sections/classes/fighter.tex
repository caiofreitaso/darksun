...
% \textbf{Weapon Training (Ex):} At 5th level, a fighter improves his aptitude in martial weapons. He gains a +1 competence bonus on his attack and weapon damage rolls whenever he is wielding a simple or martial weapon. At 9th level, and every four levels thereafter, this bonus increases by 1 (+2 at 9th, +3 at 13th, and +4 at 17th).
% arqueiro
% arremessador
% 2 armas
% 2 mãos

\textbf{Combat Style:} At 5th level, a fighter chooses a combat style to specialize. He may choose one style from the following list.
...
\textbf{Martial Prowess:} At 7th level and every two levels thereafter, a fighter improves his repertoire with new techniques. He may choose one of the following options.
...
\textit{Aim (Ex):} A fighter can take full-round action to make a \skill{Spot} check (DC = target's AC) to improve his next attack against a specific foe. His next attack against the target ignore armor bonus and natural armor bonus.
...
A fighter must be at least 11th level to select this technique.

\textit{Hawkeye (Ex):} A fighter may add \onehalf his fighter levels as competence bonus to his \skill{Spot} checks.
...
% \textit{Martial Versatility (Ex):} A fighter can apply any feat he has that affects only one weapon type (such as, \feat{Weapon Focus} or \feat{Rapid Reload}) to any simple weapon.
...
\textit{Overhand Chop (Ex):} When a fighter fighter makes a single attack (with the attack action or a charge) with a two-handed weapon, he adds double his Strength bonus on damage rolls, instead of 1\onehalf.
