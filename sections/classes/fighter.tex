...
\textit{Bravery (Ex):} A fighter with this ability gains a bonus equal to \onehalf his fighter levels on Will saves against fear.
...
\textit{Second Wind (Ex):} A fighter with this ability can dig his resolve and endurance to find an extra burst of vitality. He can use a standard action to heal a number of hit points equal to his Constitution modifier $\times$ his fighter levels. He can use this ability only once per encounter.
