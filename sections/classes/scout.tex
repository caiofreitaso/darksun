...
\textit{Scout Feat:} A scout may select two skill feats or \feat{Skill Focus} in place of a trade secret. He must meet all the prerequisites for the feat. This trade secret may be chosen more than once, each time the scout must select a different feat.
