...
\textit{Thief Feat:} A thief may select an ambush feat\textsuperscript{CS} or \feat{Skill Focus} in place of a trade secret. She must meet all the prerequisites for the feat. This trade secret may be chosen more than once, each time the thief must select a different feat.
