...
\SpellcasterTable{4mm}{The Templar}{
\SpellHeader{9} \\
1st  & +0         & +2  & +0 & +2  & Domains, sigil, secular authority, requisition slave & 4 & 1+1 &&&&&&&&\\
2nd  & +1         & +3  & +0 & +3  & Intrude on slave                                     & 4 & 2+1 &&&&&&&&\\
3rd  & +2         & +3  & +1 & +3  & Accuse slave                                         & 4 & 3+1 &&&&&&&&\\
4th  & +3         & +4  & +1 & +4  & Turn or rebuke undead, judge slave                   & 4 & 3+1 & 1+1 &&&&&&&\\
5th  & +3         & +4  & +1 & +4  & Intrude on freeman                                   & 4 & 3+1 & 2+1 &&&&&&&\\
6th  & +4         & +5  & +2 & +5  & \feat{Scribe Scroll}, requisition troops             & 4 & 3+1 & 3+1 &&&&&&&\\
7th  & +5         & +5  & +2 & +5  & Accuse freeman                                       & 4 & 3+1 & 3+1 & 1+1 &&&&&&\\
8th  & +6/+1      & +6  & +2 & +6  & \feat{Brew Potion}, requisition gear                 & 4 & 3+1 & 3+1 & 2+1 &&&&&&\\
9th  & +6/+1      & +6  & +3 & +6  & Judge freeman                                        & 4 & 3+1 & 3+1 & 2+1 & 1+1 &&&&&\\
10th & +7/+2      & +7  & +3 & +7  &                                                      & 4 & 3+1 & 3+1 & 2+1 & 2+1 &&&&&\\
11th & +8/+3      & +7  & +3 & +7  & Intrude on noble                                     & 4 & 3+1 & 3+1 & 2+1 & 2+1 & 1+1 &&&&\\
12th & +9/+4      & +8  & +4 & +8  &                                                      & 4 & 3+1 & 3+1 & 2+1 & 2+1 & 2+1 &&&&\\
13th & +9/+4      & +8  & +4 & +8  & Accuse noble                                         & 4 & 3+1 & 3+1 & 2+1 & 2+1 & 2+1 & 1+1 &&&\\
14th & +10/+5     & +9  & +4 & +9  &                                                      & 4 & 3+1 & 3+1 & 2+1 & 2+1 & 2+1 & 2+1 &&&\\
...
\textit{Requisition Troops:} At 6th level, a templar with 9 or more ranks in \skill{Diplomacy} and \skill{Knowledge} (warcraft) can requisition 1d4 soldiers per level. The soldiers will all be 1st-level templars with one 2nd-level templar centurian. The soldiers cannot be ordered to leave the city without permission from her sorcerer-monarch.
...
\BigTablePair{Typical Administrative Positions}{XXX}{
