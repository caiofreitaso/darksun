...
\FeatTable[p{3cm}]{Regional}{
	\feat{Artisan} & {Nibenay, Raam, Urik} & \\
	\feat{Astrologer} & {Draj, Nibenay} & \\
	\feat{Companion} & {Kurn, Tyr} & \\
	\feat{Disciplined} & {Dwarf, Urik} & \\
	\feat{Elfish Eloy} & Half-elf, both parents must be half-elves & \\
	\feat{Freedom} & {Tyr} & \\
	\feat{Giant Killer} & {Sea of Silt} & \\
	\feat{Jungle Fighter} & {Forest Ridge, Gulg} & \\
	\feat{Legerdemain} & {Elf, Salt View} & \\
	\feat{Mansabdar} & {Raam} & \\
	\feat{Mekillothead} & {Draj, mul} & \\
	\feat{Metalsmith} & {Dwarf, Tyr} & \\
	\feat{Nature's Child} & {Gulg, halfling} & \\
	\feat{Paranoid} & {Eldaarich} & \\
	\feat{Performance Artist} & {Balic, Nibenay, Salt View} & \\
	\feat{Tarandan Method} & {Raam} & 
}
