...
Walk   & 2 km & 3 km &  5 km &  6 km &  7 km &  9 km \\
Hustle & 5 km & 7 km & 10 km & 12 km & 14 km & 18 km \\
Run    & ---  & ---  &  ---  &  ---  &  ---  &  ---  \\

\rowcolor{white}\\
\cmidrule[0pt]{1-7}
\multicolumn{7}{c}{\TableSubheader{One Day (Overland)}} \\
Walk   & 21 km & 28 km & 43 km & 50 km & 57 km & 72 km\\
Hustle & --- & --- & --- & --- & --- & --- \\
Run    & --- & --- & --- & --- & --- & --- \\
...
\BigTableBottom{Maneuverability}{l*{5}{C}}{
...
\textit{Run (\multiplied3):} Moving three times speed is a running pace for a character in heavy armor. It represents about 11 kilometers per hour for a human in full plate.

\textit{Run (\multiplied4):} Moving four times speed is a running pace for a character in light, medium, or no armor. It represents about 21 kilometers per hour for an unencumbered human, or 15 kilometers per hour for a human in chainmail.
...
& \tableheader Additional Movement Cost\\
...
\textbf{Terrain:} The terrain through which a character travels affects how much distance he or she can cover in an hour or a day (see \tabref{Terrain and Overland Movement}). A highway is a straight, major, paved road. A road is typically a dirt track. A trail is like a road, except that it allows only single-file travel and does not benefit a party traveling with vehicles. Trackless terrain is a wild area with no paths.

\Table{Terrain and Overland Movement}{lCCC}{
\tableheader Terrain & \tableheader Trackless & \tableheader Road or Trail & \tableheader Highway\footnotemark[1]\\
Boulder fields  & $\times$\onehalf       & $\times$\onehalf       & $\times$1 \\
Forest          & $\times$\onequarter    & $\times$\threequarters & $\times$1 \\
Grassland       & $\times$\onehalf       & $\times$1              & $\times$1 \\
Mountains       & $\times$\onehalf       & $\times$\threequarters & $\times$\threequarters \\
Mudflats        & $\times$\onehalf       & $\times$\threequarters & $\times$1 \\
Obsidian plains & $\times$\threequarters & $\times$1              & $\times$1 \\
Rocky badlands  & $\times$\onehalf       & $\times$\threequarters & $\times$1 \\
Salt flats      & $\times$\threequarters & $\times$1              & $\times$1 \\
Sandy wastes    & $\times$\onehalf       & $\times$\onehalf       & $\times$1 \\
Scrub plains    & $\times$\threequarters & $\times$1              & $\times$1 \\
Stony barrens   & $\times$\threequarters & $\times$1              & $\times$1 \\

% Boulder fields  & $\times$\onequarter    & $\times$\onehalf       & $\times$1 \\
% Forest          & $\times$\onethird      & $\times$\threequarters & $\times$1 \\
% Grassland       & $\times$\onehalf       & $\times$1              & $\times$1 \\
% Mountains       & $\times$\oneeighth     & $\times$\onequarter    & $\times$\onequarter \\
% Mudflats        & $\times$\onehalf       & $\times$\threequarters & $\times$1 \\
% Obsidian plains & $\times$\threequarters & $\times$1              & $\times$1 \\
% Rocky badlands  & $\times$\onehalf       & $\times$\threequarters & $\times$1 \\
% Salt flats      & $\times$\threequarters & $\times$1              & $\times$1 \\
...
% Scrub plains    & $\times$\threequarters & $\times$1              & $\times$1 \\
% Stony barrens   & $\times$\threequarters & $\times$1              & $\times$1 \\
\TableNote{4}{1 Only available by Travel domain.}
}
