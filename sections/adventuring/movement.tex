...
\textbf{Vehicle Movement}: Small vehicles have a maneuverability similar to airborne creatures, as shown on \tabref{Maneuverability}, granted these vehicles with their mounts fit within the size of a Colossal creature (9-meter space). They have turn rates, maximum turn, and so on. The vehicles' maneuverabilities are shown on \tabref{Vehicle Maneuverability}. A rider can improve the maneuverability of chariots with a DC 20 Ride check.
