...
\input{subsections/5.3-balance.tex}
\input{subsections/5.3-bluff.tex}
\input{subsections/5.3-climb.tex}
\input{subsections/5.3-concentration.tex}
...
\input{subsections/5.3-disguise.tex}
...
\input{subsections/5.3-search.tex}
...
\input{subsections/5.3-spot.tex}
\input{subsections/5.3-survival.tex}
\input{subsections/5.3-swim.tex}
\input{subsections/5.3-tumble.tex}
\input{subsections/5.3-use-magic-device.tex}
\input{subsections/5.3-use-psionic-device.tex}
\input{subsections/5.3-use-rope.tex}