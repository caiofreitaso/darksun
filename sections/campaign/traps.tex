...
\spellref{clairvoyance/clairaudience}{clairaudience} & One preselected location & +15 \\
\spell{true seeing} & Line of sight (up to 36 m) & +30 \\
\TableNote{3}{If you want the trap to “see” in the dark, you must either choose the \spell{true seeing} option or add \spell{darkvision} to the trap as well. (\emph{Darkvision} limits the trap’s sight range in the dark to 18 meters.) If \spell{invisibility}, disguises, or illusions can fool the spell being used, they can fool the visual trigger as well.}\\
}
