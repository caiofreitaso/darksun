...
\input{subsections/magic-items/using-items.tex}
\input{subsections/magic-items/size-and-magic-items.tex}
\input{subsections/magic-items/magic-items-on-the-body.tex}
