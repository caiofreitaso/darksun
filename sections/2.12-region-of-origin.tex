...
\textbf{Prestige Classes:} \class{Arrow Knight}, \class{Cerulean}, \class{Dune Trader}, \class{Eagle Knight}, \class{Jaguar Knight}, \class{Moon Priest}.
...
\textbf{Prestige Classes:} \class{Brown Cloak}, \class{Executioner}, \class{Red Guard}.
...
\textbf{Prestige Classes:} \class{Elite Sniper}, \class{Grove Master}, \class{Halfling Protector}, \class{Tribal Psionicist}.
...
\textbf{Feats:} \feat{Artisan}, \feat{Mansadbar}, \feat{Tarandan Method}.
...
\textbf{Prestige Classes:} \class{Black Cassock}, \class{Draqoman}, \class{Dune Trader}, \class{Templar Knight}.
