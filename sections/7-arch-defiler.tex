...
Characters with ranks in \skill{Knowledge} (arcana) can research arch defilers to learn more about them. When a character makes a skill check, read or paraphrase the following, including the information from lower DCs.

\textbf{DC 15:} The arch defiler is an arcane caster who focuses on defiling as an energy source.
