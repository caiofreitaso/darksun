...
12 & +12/+7/+2 & +8 & +4 & +4 & Bonus feat, rage 4/day \\
...
\textbf{Bonus Feats:} Starting at 3rd level, a barbarian gains a bonus feat. The barbarian gains an additional bonus feat every three barbarian levels thereafter (6th, 9th, 12th, 15th, and 18th level). These bonus feats must be drawn from the following list: \feat{Cleave}, \feat{Combat Reflexes}, \feat{Diehard}, \feat{Endurance}, \feat{Fearsome}, \feat{Great Cleave}, \feat{Great Fortitude}, \feat{Improved Bull Rush}, \feat{Improved Sunder}, \feat{Iron Will}, \feat{Jaguar Roar}, \feat{Leadership}, \feat{Lightning Reflexes}, \feat{Mind Over Body}, \feat{Power Attack}, \feat{Rapid Metabolism}, \feat{Reckless Offense}, \feat{Run}, \feat{Stand Still}, and \feat{Track}. A barbarian must still meet all prerequisites for a bonus feat, including ability score and base attack bonus minimums.

These bonus feats are in addition to the feat that a character of any class gets from advancing levels. A barbarian is not limited to this list of bonus feats when choosing these feats.
