...
\textbf{Bonus Feats:} At 5th, 10th, 15th, and 20th level, a wizard gains a bonus feat. At each such opportunity, she can choose a metamagic feat, a raze feat, an item creation feat, Path Dexter, Path Sinister, or Spell Mastery. The wizard must still meet all prerequisites for a bonus feat, including caster level minimums.
...
\textbf{Weapons:} Dagger (1d4/19–20), light crossbow with 20 bolts (1d6/x3, 60 ft.).
