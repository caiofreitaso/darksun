...
\node[color=richblack] at (-0.707*0.75\halflength*0.5, 0.707*0.75\halflength*0.5) {\tableheader \contour{white}{Air}};
\node[color=richblack] at ( 0.707*0.75\halflength*0.5,-0.707*0.75\halflength*0.5) {\tableheader \contour{white}{Earth}};
\node[color=richblack] at ( 0.707*0.75\halflength*0.5, 0.707*0.75\halflength*0.5) {\tableheader \contour{white}{Fire}};
\node[color=richblack] at (-0.707*0.75\halflength*0.5,-0.707*0.75\halflength*0.5) {\tableheader \contour{white}{Water}};
...
\draw[line width=0.2mm, color=black, draw, fill=white]
   ( 0.707\halflength*0.5, 0.707\halflength*0.5) arc (45:-45:\halflength*0.5)
-- ( 0    ,-0.707\halflength*0.5)
-- ( 0    , 0.707\halflength*0.5)
-- ( 0.45\halflength*0.5, 0.707\halflength*0.5)
--cycle;

\draw[line width=0.2mm, color=black, draw, fill=white]
   (-0.707\halflength*0.5,-0.707\halflength*0.5) arc (225:135:\halflength*0.5)
-- ( 0    , 0.707\halflength*0.5)
-- ( 0    ,-0.707\halflength*0.5)
-- (-0.45\halflength*0.5,-0.707\halflength*0.5)
--cycle;
...
\path[pattern=dots, pattern color=black!40]
   (-0.707\halflength*0.5,-0.707\halflength*0.5) arc (225:210:\halflength*0.5)
-- (-.1mm  ,-0.45\halflength*0.5)
-- (-.1mm  ,-0.707\halflength*0.5)
--cycle;
\path[pattern=dots, pattern color=black!40]
   (0.707\halflength*0.5,-0.707\halflength*0.5) arc (-45:-30:\halflength*0.5)
-- (.1mm  ,-0.45\halflength*0.5)
-- (.1mm  ,-0.707\halflength*0.5)
--cycle;

\path[pattern=dots, pattern color=black!20]
   (-0.707\halflength*0.5, 0.707\halflength*0.5) arc (135:150:\halflength*0.5)
-- (-0.1mm   , 0.45\halflength*0.5)
-- (-0.1mm   , 0.707\halflength*0.5)
--cycle;
\path[pattern=dots, pattern color=black!20]
   (0.707\halflength*0.5, 0.707\halflength*0.5) arc (45:30:\halflength*0.5)
-- (0.1mm   , 0.45\halflength*0.5)
...
\path[pattern=crosshatch dots, pattern color=black!20]
   (-0.866\halflength*0.5, 0.45\halflength*0.5) arc (150:210:\halflength*0.5)
-- (-0.1mm   ,-0.45\halflength*0.5)
-- (-0.1mm   , 0.45\halflength*0.5)
--cycle;
\path[pattern=crosshatch dots, pattern color=black!20]
   (0.866\halflength*0.5, 0.45\halflength*0.5) arc (30:-30:\halflength*0.5)
-- (0.1mm,-0.45\halflength*0.5)
-- (0.1mm, 0.45\halflength*0.5)
--cycle;
\draw[line width=0.2mm, color=black, draw, fill=white] ( 0.707\halflength*0.5, 0.707\halflength*0.5) arc  (45:135:\halflength*0.5) -- ( 0.707\halflength*0.5, 0.707\halflength*0.5) --cycle;
\draw[line width=0.2mm, color=black, draw, fill=black] (-0.707\halflength*0.5,-0.707\halflength*0.5) arc (225:315:\halflength*0.5) -- (-0.707\halflength*0.5,-0.707\halflength*0.5) --cycle;
