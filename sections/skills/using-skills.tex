...
\Table{Difficulty Class Examples}{lX}{
  \tableheader Difficulty (DC)
& \tableheader Example (Skill Used)\\
...
\Table{Skill Synergies}{L p{4.9cm}}{
  \tableheader 5 or more ranks in...
& \tableheader Gives a +2 bonus on... \\
...
~ (alchemy) & Craft (poisonmaking) checks\\
...
Heal & Craft (alchemy) checks involving antitoxins \\
Jump & Tumble checks\\
