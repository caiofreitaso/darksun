...
\input{subsections/skills/appraise.tex}
\Figure*{b}{images/gladiator-5.png}
\input{subsections/skills/autohypnosis.tex}
\Figure*{b}{images/bluff.png}
\input{subsections/skills/balance.tex}
\input{subsections/skills/bluff.tex}
\input{subsections/skills/climb.tex}
\Figure{b}{images/psion-5.png}
\input{subsections/skills/concentration.tex}
\Figure{b}{images/craft.png}
\input{subsections/skills/craft.tex}
\input{subsections/skills/decipher-script.tex}
\Figure*{t}{images/merchant-3.png}
\input{subsections/skills/diplomacy.tex}
\input{subsections/skills/disable-device.tex}
\input{subsections/skills/disguise.tex}
\input{subsections/skills/escape-artist.tex}
\input{subsections/skills/forgery.tex}
\input{subsections/skills/gather-information.tex}
\input{subsections/skills/handle-animal.tex}
\Figure{b}{images/arena-4.png}
\input{subsections/skills/heal.tex}
\Figure{t}{images/hide-2.png}
\input{subsections/skills/hide.tex}
% \Figure{b}{images/b-rohg.png}
\input{subsections/skills/intimidate.tex}
\Figure{t}{images/raiders-5.png}
\input{subsections/skills/jump.tex}
\Figure*{b}{images/books-2.png}
\input{subsections/skills/knowledge.tex}
\input{subsections/skills/listen.tex}
\input{subsections/skills/literacy.tex}
\input{subsections/skills/move-silently.tex}
\Figure*{b}{images/performance.png}
\input{subsections/skills/open-lock.tex}
\input{subsections/skills/perform.tex}
\input{subsections/skills/profession.tex}
% \Figure*{b}{images/silt-sea-2.png}
\Figure*{b}{images/roc-rider.png}
\input{subsections/skills/psicraft.tex}
\input{subsections/skills/ride.tex}
\input{subsections/skills/search.tex}
\input{subsections/skills/sense-motive.tex}
\input{subsections/skills/sleight-of-hand.tex}
\input{subsections/skills/speak-language.tex}
\input{subsections/skills/spellcraft.tex}
\input{subsections/skills/spot.tex}
\Figure{b}{images/silhouette.png}
\input{subsections/skills/survival.tex}
\input{subsections/skills/swim.tex}
\input{subsections/skills/tumble.tex}
\input{subsections/skills/use-magic-device.tex}
\input{subsections/skills/use-psionic-device.tex}
\input{subsections/skills/use-rope.tex}
