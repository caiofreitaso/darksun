...
With the money that the crematory generates, which is owned by Shatri, the Alliance has increased its influence at every level of the government (mostly through bribes). They also allocate resources for spell research---as Shatri wants to learn the spell to become an avangion (see \chapref{Epic Characters}).
