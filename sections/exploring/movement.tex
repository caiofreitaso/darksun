...
\textit{Minimum forward speed} & None & None & Half & Half & Half \\
\textit{Hover} & Yes & Yes & No & No & No \\
\textit{Move backward} & Yes & Yes & No & No & No \\
\textit{Reverse} & Free & $-5$ ft. & No & No & No \\
\textit{Turn} & Any & 90{\textdegree} per 1.5 m & 45{\textdegree} per 1.5 m & 45{\textdegree} per 1.5 m & 45{\textdegree} per 3 m \\
\textit{Turn in place} & Any & 90{\textdegree} per 1.5 m & 45{\textdegree} per 1.5 m & No & No \\
\textit{Maximum turn} & Any & Any & 90{\textdegree} & 45{\textdegree} & 45{\textdegree} \\
\textit{Up angle} & Any & Any & 60{\textdegree} & 45{\textdegree} & 45{\textdegree} \\
\textit{Up speed} & Full & Half & Half & Half & Half \\
\textit{Down angle} & Any & Any & Any & 45{\textdegree} & 45{\textdegree} \\
\textit{Down speed} & Double & Double & Double & Double & Double \\
\textit{Between down and up} & 0 & 0 & 1.5 m & 3 m & 6 m \\
}
...
Transport chariot (kank) & one person & 4.5 km & 36 km \\
