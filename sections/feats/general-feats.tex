...
{}
{You can use your Intelligence bonus (rather than your Charisma bonus) on all \skill{Bluff} checks.}
{}{}
...
% \Table{}{X c}{
%   \tableheader PC Background
% & \tableheader Bribe Modifier \\
% Renown             & $-2$\\
...
& \tableheader Arcane Spellcaster Level \\
...
\rowcolor{white}
& & \multicolumn{6}{c}{\tableheader Number of Followers by Level}\\
\cmidrule[0.5pt]{3-8}
  \tableheader Leadership Score
& \tableheader Cohort Level & 1st & 2nd & 3rd & 4th & 5th & 6th \\
1 or lower   &      &     &     &     &     &     &     \\
2            &  1st &     &     &     &     &     &     \\
3            &  2nd &     &     &     &     &     &     \\
4            &  3rd &     &     &     &     &     &     \\
...
{You can disguise your spells as psionic powers by making a successful \skill{Bluff} check (DC 12 + spell level). An onlooker suspecting the nature of your spellcasting can attempt to identify a spell being cast using the \skill{Spellcraft} skill.}{}{}
...
\Table{Track DC Modifiers}{X Z{1.4cm}}{
  \tableheader Condition
& \tableheader \skill{Survival} DC Modifier\\
...
& \tableheader DC
& \tableheader Checks Required\\
Small or large tribe &  5 & 1d3\\
Village              & 10 & 1d4+1\\
Small or large town  & 15 & 2d4\\
Small or large city  & 20 & 2d4+2\\
Metropolis           & 25 & 3d4+1\\
Megalopolis          & 30 & 3d4+2\\
}
...
{}
{Your latent power of psionics flares to life, conferring upon you the designation of a psionic character. You learn one psionic power that does not have prerequistes. You must have the relevant key ability score 10 + the power's level (see the \class{Psion} class). For all purposes, you have one manifester level.
