...
Elemental incarnation\footnotemark[1] & Matching subtype or patron element, or preserver & 5th\\
Paraelemental incarnation\footnotemark[1] & Matching subtype or patron element, or defiler & 5th\\
...
\rowcolor{white}
\multicolumn{3}{l}{1 Apply the template to a familiar from the standard list.}\\
}
...
{Making a jaguar roar is a swift action. All intelligent creatures who can hear you and who are within 30 feet may become shaken for 2d4 rounds. A creature in the affected area can resist the effect with a successful Will save (DC 10 + your level + Charisma modifier). Any creature that successfully resists the effect cannot be affected again by the same character's jaguar roar for 24 hours.}
...
{\skill{Intimidate} 5 ranks, member of Takrits, Savak, or Neshtap Order.}
