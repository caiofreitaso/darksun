...
\Feat[Psionic, Racial]{Psionic Dwarven Focus}
...
\Feat[Psionic, Racial]{Psionic Elf Run}
...
\Feat[Psionic, Racial]{Psionic Haggler}
{You improve your haggling skills when psionic focused.}
{Cha 15, elf.}
{You must be psionically focused to use this feat. Whenever you bargain, the result of this \skill{Diplomacy} opposed check is always one step better for you.}
{}
