...
\FeatTable{Psionic}{
	...
	\feat{Psionic Dwarven Focus}\footnotemark[2] & Dwarf & Advantage all checks related to your dwaven focus\\
	\feat{Psionic Elf Run}\footnotemark[2] & Elf & +4.5 m to speed while in elf run state\\
	...
	\feat{Psionic Haggler}\footnotemark[2] & Cha 15, elf & Get better deals when bargaining\\
	...
	\feat{Wild Telepath} & Cha 13 & Use Charisma as key ability for metacreativity and telepathy\\
	...
	\BigTableNote{3}{1 Spend psionic focus}\\
	\BigTableNote{3}{2 Must be psionic focused}\\
