\FeatTable[>{\raggedright}p{3.5cm}]{Fighter}{
	...
	\feat{Exotic Weapon Proficiency}\footnotemark[1] & Base attack bonus +1 & No penalty when attacking with chosen weapon\\
	\feat{Implacable Defender} & Str 13, Base attack bonus +3 & +2 bonus to resist special attacks and improved defense\\
	\feat{Improved Critical}\footnotemark[1] & Proficient with weapon, base attack bonus +8 & Double threat range of chosen weapon\\
	~ \feat{Greater Critical}\footnotemark[1] & Proficient with weapon, base attack bonus +12, \feat{Improved Critical} with weapon & +1 to critical multiplier of chosen weapon and may score critical on immune foes\\
	...
	\feat{Multiweapon Fighting} & Dex 13, three or more hands & Reduce penalties for fighting with multiple weapons \\
	~ \feat{Improved Multiweapon Fighting} & Dex 15, three or more arms, \feat{Multiweapon Fighting}, base attack bonus +9 & Second off-hand attacks with $-5$ penalty\\
	~ ~ \feat{Greater Multiweapon Fighting} & Dex 19, three or more arms, \feat{Improved Multiweapon Fighting}, \feat{Multiweapon Fighting}, base attack bonus +15 & Third off-hand attacks with $-10$ penalty\\
...
\FeatTable[>{\raggedright}p{3.5cm}]{Fighter}{
	...
	~ ~ \feat{Sharp-Shooting} & \feat{Point Blank Shot}, \feat{Precise Shot}, base attack bonus +3 & Halve opponent's cover bonus\\
	...
	\feat{Rapid Reload}\footnotemark[1] & \feat{Weapon Proficiency} with crossbow type chosen & Reduce reload time to free action or move action\\
	...
	\feat{Weapon Focus}\footnotemark[1] & Proficiency with weapon, base attack bonus +1 & +1 bonus on attack rolls with chosen weapon\\
	~ \feat{Greater Weapon Focus}\footnotemark[1] & Proficiency with weapon, \feat{Weapon Focus} with weapon, fighter level 8th & +1 bonus on attack rolls with chosen weapon\\
	~ ~ \feat{Greater Weapon Specialization}\footnotemark[1] & Proficiency with weapon, \feat{Greater Weapon Focus} with weapon, \feat{Weapon Focus} with weapon, \feat{Weapon Specialization} with weapon, fighter level 12th& +2 bonus damage with chosen weapon\\
	~ \feat{Power Critical}\footnotemark[2] & \feat{Weapon Focus} with weapon, base attack bonus +4 & +4 bonus to confirm critical with chosen weapon\\
	~ \feat{Weapon Specialization}\footnotemark[1] & Proficiency with weapon, \feat{Weapon Focus} with weapon, fighter level 4th & +2 bonus damage with chosen weapon\\
