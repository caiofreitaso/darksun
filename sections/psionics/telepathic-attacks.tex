...
\textit{Maintaining Partial Contact:} Each partial contact requires a maintenance cost of 1 power point per round. Once you reach three partial contacts, you only to maintain \psionic{contact}. % You do not need to spend power points to maintain full contact. Once a mind is open, you have no need to force yourself into it.
...
\textit{Maintaining Contact:} When contact is made via telepathic attacks, you need to maintain it exactly like the \psionic{contact} power, with a maintenance cost of 1 power point per round.
