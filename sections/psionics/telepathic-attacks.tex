...
\textit{Maintaining Partial Contact:} Each partial contact requires a maintenance cost of 1 power point per round. Once you reach two partial contacts, you only to maintain \psionic{contact}. % You do not need to spend power points to maintain full contact. Once a mind is open, you have no need to force yourself into it.
...
Psions have access to a number of telepathic defenses: \psionic{intellect fortress}, \psionic{mental barrier}, \psionic{peace of mind}, \psionic{thought shield}, \psionic{tower of iron will}. These psionic powers are universal and available to any psion, no matter which discipline they chose to specialize.
...
& \tableheader \psionic{Peace of Mind}
& \tableheader \psionic{Thought Shield}
& \tableheader \psionic{Tower of Iron Will} \\
\psionic{Ego Whip}       & $-5$ & $-4$ &  +2  &  +0  & $-4$ \\
\psionic{Id Insinuation} & $-3$ &  +2  & $-5$ &  +2  & $-4$ \\
\psionic{Mind Thrust}    & $-5$ & $-4$ &  +2  & $-3$ & $-4$ \\
\psionic{Psionic Blast}  & $-3$ &  +0  &  +0  &  +3  & $-4$ \\
\psionic{Psychic Crush}  & $-3$ & $-2$ &  +0  & $-3$ & $-4$ \\
}
...
\begin{enumerate*}
	\item Attacker must succeed in the power check for \psionic{ego whip}. Their power check total bonus is
