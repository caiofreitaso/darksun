...
\textbf{Smart Defense (Ex):} At 3rd level, a fighter gets improved defense capabilities whenever he is using an armor. Each type of armor provides a different bonus to the fighter:

\begin{itemize*}
\item \textit{Light armor:} +1 dodge bonus to AC;
\item \textit{Medium armor:} Increase armor bonus and maximum Dexterity bonus by +1;
\item \textit{Heavy armor:} DR 1/adamantine.
\end{itemize*}

Every four levels thereafter those bonus increase by 1, at 7th, 11th, 15th and 19th level.

% \textbf{Leadership:} At 11th level, a fighter gains the benefit of the \feat{Leadership} feat.
