...
\subsection{Browncloak Lore}
Characters with ranks in \skill{Knowledge} (local [Eldaarich]) can research browncloak to learn more about them. When a character makes a skill check, read or paraphrase the following, including the information from lower DCs.
