...
{4}
{\PrestigeMonkTable}{
 1 &  +1 & +2 & +2 & +2 & +1 & 1d6  & Bonus feat, unarmed strike & +1 level of existing manifesting class\\
 ...
 5 &  +5 & +4 & +4 & +4 & +2 & 1d8  & Bonus feat, mental mastery & +1 level of existing manifesting class\\
 ...
 9 &  +9 & +6 & +6 & +6 & +3 & 2d6  & Bonus feat, disciplined mind & +1 level of existing manifesting class\\
...
\textbf{Manifesting:} At every level, a sensei gains additional power points per day and access to new powers as if she had also gained a level in whatever manifesting class she belonged to before she added the prestige class. She does not, however, gain any other benefit a character of that class would have gained (bonus feats, metapsionic or item creation feats, psicrystal special abilities, and so on). This essentially means that she adds the level of sensei to the level of whatever manifesting class the character has, then determines power points per day, powers known, and manifester level accordingly.
