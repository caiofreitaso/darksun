...
\textit{Revert Awakening} \textbf{(Sp):} At 5th level, an exterminator can revert the effect of spells that animate plants: \spell{awaken}, \spell{animate plants}, and \spell{shambler}. In order to revert those spells, the exterminator must spend a spell slot of the same or higher level as the spell being reverted. If the spell being reverted required XP to cast, the exterminator must spend the same amount of XP to revert the spell.
}
