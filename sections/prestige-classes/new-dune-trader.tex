...
3 & +2 & +1 & +1 & +3 & Agent +2/+1, master linguist\\
4 & +3 & +1 & +1 & +4 & Contact (2), dazzle\\
5 & +3 & +1 & +1 & +4 & Fast talk, \feat{Leadership}\\
6 & +4 & +2 & +2 & +5 & Contact (3), skill mastery\\
7 & +5 & +2 & +2 & +5 & Agent +4/+2, slippery mind\\
8 & +6 & +2 & +2 & +6 & Contact (4), taunt\\
9 & +6 & +3 & +3 & +6 & Allies\\
10 & +7 & +3 & +3 & +7 & Contact (5), intelectual agility, sustaining presence\\
}
{
...
\textbf{Master Linguist (Ex):} At 4th level, a dune trader becomes a master linguist. Whenever he encounters a new language, either spoken or written, that he does not know, he can make an Intelligence check (for a spoken language) or a \skill{Decipher Script} check (for a written language) to determine if he can understand it.
...
\textbf{Intellectual Agility (Su):} Starting at 10th level, a dune trader can channel his intellect to more physical needs. He adds his Intelligence bonus (if any) to his initiative checks and Reflex saves.

\textbf{Sustaining Presence (Su):} Starting at 10th level, a dune trader knows how to call upon his force of personality to help keep herself alive in tense or dangerous situations. He adds his Charisma bonus (if any) to his Concentration checks and Fortitude saves.
}
% {}
% {local}
