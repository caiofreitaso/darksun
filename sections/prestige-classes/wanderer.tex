...
\textbf{Lore:} A wanderer may recall ancient lore, just like a bard can with bardic knowledge. The wanderer adds their wanderer level, cleric level, and their Wisdom modifier to the lore check, which functions otherwise exactly like a bardic knowledge check.
