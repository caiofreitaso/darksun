...
If a metamind using this ability enters a \psionic{metaconcert}, his power point reserve is accessed normally for the purpose of his contributing to the pool.
}
% {}
% {psionics}
