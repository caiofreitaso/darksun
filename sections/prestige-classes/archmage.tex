...
\textit{Mastery of Counterspelling:} When the archmage counterspells a spell, it is turned back upon the caster as if it were fully affected by a \spell{spell turning} spell. If the spell cannot be affected by \spell{spell turning}, then it is merely counterspelled. This ability costs one 7th-level spell slot.
