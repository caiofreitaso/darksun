...
{4}
{\PrestigePowerTable}{
 1st & +0 & +0 & +2 & +2 & Scorn earth, \feat{Sidestep Charge} & +1 level of existing manifesting class\\
...
While she remains within 30 centimeters of a surface, she can make melee and ranged attacks normally, but if she moves any higher, she incurs the penalties on melee and ranged attack rolls as if she were the subject of the \psionic{psionic levitate} power.
...
\textbf{Dimension Step (Su):} An elocater of 3rd level or higher can slip psionically between spaces as if using the \psionic{psionic dimension door} power, once per day. The elocater cannot bring any other creatures with her. Her manifester level for this effect is equal to her elocater level.
