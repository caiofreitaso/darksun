...
\textbf{Aquatic:} You gain a +4 competence bonus on \skill{Swim} checks, or a +3-meter bonus to your swim speed if you have one. You gain a +1 insight bonus on attack and damage rolls against aquatic creatures.
...
\textbf{Forest:} You have a +4 competence bonus on \skill{Hide} checks. You gain a +1 insight bonus on attack and damage rolls against forest creatures.

\textbf{Hills:} You gain a +4 competence bonus on \skill{Listen} checks. You gain a +1 insight bonus on attack and damage rolls against hills creatures.

\textbf{Marsh:} You have a +4 competence bonus on \skill{Move Silently} checks. You gain a +1 insight bonus on attack and damage rolls against marsh creatures.

\textbf{Mountains:} You gain a +4 competence bonus on \skill{Climb} checks, or a +3-meter bonus to your climb speed if you have one. You gain a +1 insight bonus on attack and damage rolls against mountain creatures.

\textbf{Plains:} You have a +4 competence bonus on \skill{Spot} checks. You gain a +1 insight bonus on attack and damage rolls against plains creatures.
