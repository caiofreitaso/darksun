...
Characters with ranks in \skill{Knowledge} (local) can research assassins to learn more about them. When a character makes a skill check, read or paraphrase the following, including the information from lower DCs.

\textbf{DC 15:} Assassins are spies that kill anyone for more than the right amount of money.

\textbf{DC 20:} Assassins specialize in dealing a single fatal attack. Their victims are known for being poisoned.

\textbf{DC 30:} Besides poison and their death attack, assassins can cast spells that enhance their abilities.