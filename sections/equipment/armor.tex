...
\BigTable{Armor and Shields}{X r{9mm}r{11mm} z{7mm}z{11mm}z{8mm}z{9mm} *{3}{z{7mm}} *{3}{r{11mm}r{11mm}r{11mm}}}{
\cmidrule[0pt]{2-3}
	\rowcolor{white}
& \multicolumn{2}{c}{\tableheader Cost}
& \multirow[b]{2}{7mm}{\centering \tableheader AC Bonus}
& \multirow[b]{2}{11mm}{\centering \tableheader Max. Dex Bonus}
...
\tableheader Armor & \tableheader S/M & \tableheader L & & & & & \tableheader 6 m & \tableheader 9 m & \tableheader 12 m & \tableheader S & \tableheader M & \tableheader L\\

\multicolumn{13}{l}{\TableSubheader{Light Armor}}\\
...
\multicolumn{13}{l}{\TableSubheader{Medium Armor}}\\
...
\multicolumn{13}{l}{\TableSubheader{Heavy armor\footnotemark[1]}}\\
...
\multicolumn{13}{l}{\TableSubheader{Shields}}\\
...
\multicolumn{13}{l}{\TableSubheader{Extras}}\\
...
\BigTableNote{13}{1 When running in heavy armor, you move only triple your speed, not quadruple.}\\
\BigTableNote{13}{2 A tower shield can instead grant you cover.}\\
\BigTableNote{13}{$\star$ Hand not free to cast spells or employ skills.}\\
}
...
\TableNote{4}{1 If the character has some help, cut this time in half. A single character doing nothing else can help one or two adjacent characters. Two characters can't help each other don armor at the same time.}\\
\TableNote{4}{2 The wearer must have help to don this armor. Without help, it can be donned only hastily.}\\
}
