...
Concentration (Con), Craft (Int), Handle Animal (Cha), Heal (Wis), Hide (Dex), Knowledge (nature) (Int), Listen (Wis), Move Silently (Dex), Profession (Wis), Ride (Dex), Spellcraft (Int), Spot (Wis), Survival (Wis).
