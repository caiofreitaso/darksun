...
\begin{figure}[t!]
\centering
\includegraphics[width=\columnwidth]{images/thrikreen-2.png}
\WOTC
\end{figure}
...
\begin{itemize*}
    ...
    \item Leap (Ex): Thri-kreen are natural jumpers, gaining a +30 racial bonus to all \skill{Jump} checks.
    ...
    \item Alien Mind (Ex): A thri-kreen has dificulty understanding how the humanoid minds work. Whenever a thri-kreen targets a creature of another race with mind-affecting psionic powers, that creature gains +1 to its save against those powers.
