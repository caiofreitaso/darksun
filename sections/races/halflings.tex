\Figure*{b}{images/halfling-2.png}
...
\begin{itemize*}
    ...
    \item Resilience: Halflings add their Constitution bonus as racial bonus on saving throws against poison, spells, and spell-like effects.
    ...
    \item Favored Class: Ranger or Thief. A halfling must choose between ranger or thief as favored class. This choice cannot be changed. A multiclass halfling's chosen class does not count when determining class prerequisites for multiclassing.
