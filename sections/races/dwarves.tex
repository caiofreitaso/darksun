...
\begin{itemize*}
    ...
    \item +2 morale bonus on all checks directly related to their focus. This includes a skill bonus, an attack bonus, a damage bonus, or a saving throw bonus, or even a bonus to manifestation or spell save DCs.
    \item Automatic Languages: Common and Dwarven. Bonus Languages: Elven, Giant, Gith, Kreen, and Saurian.
    \item Favored Class: Gladiator. A multiclass dwarf's gladiator class does not count when determining class prerequisites for multiclassing.%whether he takes an experience point for multiclassing.
\end{itemize*}
