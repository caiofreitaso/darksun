...
\begin{itemize*}
    ...
    \item Favored Class: Gladiator. A multiclass dwarf's gladiator class does not count when determining whether he takes an experience point for multiclassing.
\end{itemize*}