...
\MonsterStatsDescription{
    LOREM IPSUM. The statistics block is for a human 2nd-level fighter with the military officer archetype.

    Mercenary archers speak Common and their city-state's language.
}

A mercenary archer work in groups focused on warfare, instead of the smaller scale defense of caravan troops. They are the best trained ranged mercenary unit, so all troops shoot in unison---either at a single dangerous target at a time, or at a large area with enemy troops. T

\textbf{Military Training:} A mercenary archer gain +1 permanent bonus on Constitution.

\subsubsection{Mercenary Crossbowman}
\MonsterStatsDescription{
    LOREM IPSUM. The statistics block is for a human 1st-level fighter with the military officer archetype.

    Mercenary crossbowmen speak Common and their city-state's language.
}

A mercenary crossbowman has a different role than a mercenary archer, as crossbowmen are less mobile, and thus more vulnerable to rapid 

\textbf{Military Training:} A caravan infantry gain +1 permanent bonus on Constitution.


\BigTable{}{lXX}{
& \tableheader Mercenary Light Infantry
& \tableheader Mercenary Heavy Infantry \\
\cmidrule[0pt]{1-3}
& \tableheader Medium Humanoid (human)
& \tableheader Medium Humanoid (human) \\
...
\tableheader Base Attack/Grapple:
    ...
    & +2/+4 \\
\tableheader Attack:
    & Shortspear +3 melee (1d6+2), or shortspear +3 ranged (1d6+2)
    & Shortspear +4 melee (1d6+2), or shortspear +3 ranged (1d6+2) \\
\tableheader Full Attack:
    & Shortspear +3 melee (1d6+2)
...
\tableheader Challenge Rating:
    ...
    & 1 \\
\tableheader Treasure:
    & 3 short spears, leather armor, light wooden shield
