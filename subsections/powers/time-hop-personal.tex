...
}
{
	...
	You do not exist for any normal game purpose during the period when you hop time. If, for example, a \spell{fireball} spell detonates in the room while you hop time, you are completely protected against its effects. In fact, unless the blast leaves visible effects (charred walls or corpses or sulfurous fumes), you won't even know it happened. You see none of the intervening events.
