\Psionic{Molecular Rearrangement}{molecular rearrangement}
{Psychokinesis}
{
	\textbf{Level:}
	Kineticist 6\\
	...
	6 pp/hour\\
	\textbf{Prerequisites:}
	\psionic{molecular manipulation}, \psionic{psionic telekinesis}\\
