...
}
{
	...
	However, these materials can be rearranged or restructured if you also know \psionic{matter rearrangement}. By combining these two powers, you could manufacture diamonds from coal dust or a sword from rocks containing iron ore. You must succeed on an appropriate skill check to make a complex item.
}
