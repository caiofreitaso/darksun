...
\textbf{Contact:} Some telepathic powers have \psionic{contact} as a cost. You do not need to pay power points to manifest these powers, but this means that you must have opened the target's mind either via the \psionic{contact} power or via telepathic attacks (see below).