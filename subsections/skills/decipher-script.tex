...
\textbf{Special:} A character with the \feat{Diligent} feat gets a +2 bonus on Decipher Script checks.

\textbf{Synergy:} If you have 5 or more ranks in Decipher Script, you get a +2 bonus on \skill{Forgery} checks, as well as on \skill{Use Magic Device} checks involving scrolls.