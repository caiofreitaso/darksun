\Skill{Search}{Int}
\textbf{Check:} You generally must be within 3 meters of the object or surface to be searched. The table below gives DCs for typical tasks involving the Search skill.
