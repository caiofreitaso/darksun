...
\textbf{Special:} A silk rope gives you advantage on Use Rope checks. If you cast an \spell{animate rope} spell on a rope, you get advantage on any Use Rope checks you make when using that rope.

Using both options give +2 circumstance bonus on the check.
