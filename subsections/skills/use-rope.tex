...
\textbf{Special:} A silk rope gives you +2 circumstance bonus on Use Rope checks. If you cast an \spell{animate rope} spell on a rope, you get +2 circumstance bonus on any Use Rope checks you make when using that rope.
