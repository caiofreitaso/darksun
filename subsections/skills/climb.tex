...
A climber's kit gives you +2 circumstance bonus on Climb checks.
...
\Table{Climb DC Modifiers}{b{11mm} X}{
\tableheader Climb DC Modifier\footnotemark[1] & Example Surface or Activity\\
...
\TableNote{2}{1 These modifiers are cumulative; use any that apply.}
}
