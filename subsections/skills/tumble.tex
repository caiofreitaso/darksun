...
\textbf{Check:} You can land softly when you fall or tumble past opponents. You can also tumble to entertain an audience (as though using the \skill{Perform} skill). The DCs for various tasks involving the Tumble skill are given on the table below.
...
35 & Stand up from prone as free action\\
}
...
\textit{Accelerated Tumbling:} You try to tumble past or through enemies more quickly than normal. By accepting a $-10$ penalty on your Tumble checks, you can move at your full speed instead of one-half your speed.
