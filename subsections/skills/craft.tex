...
In some cases, the \spell{fabricate} spell can be used to achieve the results of a Craft check with no actual check involved. However, you must make an appropriate Craft check when using the spell to make articles requiring a high degree of craftsmanship.

A successful Craft check related to woodworking in conjunction with the casting of the \spell{ironwood} spell enables you to make wooden items that have the strength of steel.

When casting the spell \spell{minor creation}, you must succeed on an appropriate Craft check to make a complex item.
...
If you have 5 ranks in \skill{Heal}, you get a +2 bonus on Craft (alchemy) checks involving antitoxins.
