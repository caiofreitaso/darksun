...
\textbf{Access:} As students of the House of the Mind, PCs have access to the prestige classes \class{Psiologist} and \class{War Mind}. These advanced students frequently receive personal instruction from Tectuktitlay, who trusts high-level training to no one else.
