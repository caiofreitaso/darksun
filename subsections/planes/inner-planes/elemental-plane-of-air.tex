...
\node[color=richblack] at (0,  5.25mm) {\tableheader \contour{white}{Quasielemental Lightning}};
\node[color=richblack] at (0, 0)    {\tableheader \contour{white}{Elemental Air}};
\node[color=richblack] at (0, -5.25mm) {\tableheader \contour{white}{Quasielemental Vacuum}};
\end{scope}
\end{tikzpicture}
\end{figure}
