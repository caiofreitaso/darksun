...
\node[color=richblack] at (0,  5.25mm) {\tableheader \contour{white}{Quasielemental Radiance}};
\node[color=richblack] at (0, 0)    {\tableheader \contour{white}{Elemental Fire}};
\node[color=richblack] at (0, -5.25mm) {\tableheader \contour{white}{Quasielemental Ash}};
\end{scope}
\end{tikzpicture}
\end{figure}
