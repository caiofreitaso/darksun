...
\node[color=richblack] at (0,  5.25mm) {\tableheader \contour{white}{Quasielemental Steam}};
\node[color=richblack] at (0, 0)    {\tableheader \contour{white}{Elemental Water}};
\node[color=richblack] at (0, -5.25mm) {\tableheader \contour{white}{Quasielemental Salt}};
\end{scope}
\end{tikzpicture}
\end{figure}
