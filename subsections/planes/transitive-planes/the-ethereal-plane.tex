...
\path[fill=black!20] (-\columnwidth/2-2mm, 25mm) rectangle (\columnwidth/2-2mm, 15mm);
\path[fill=white] (-\columnwidth/2-2mm, 15mm) rectangle (\columnwidth/2-2mm, 0mm);
\path[pattern=crosshatch dots, pattern color=black!20] (-\columnwidth/2-2mm, 15mm) rectangle (\columnwidth/2-2mm, 9mm);
\path[pattern=dots, pattern color=black!20] (-\columnwidth/2-2mm, 9mm) rectangle (\columnwidth/2-2mm, 5mm);
\path[line width=0.2mm, draw, fill=white] (-\columnwidth/2-1.9mm, 0.1mm) rectangle (\columnwidth/2-2.1mm, -10mm);
\path[fill=black!40] (-\columnwidth/2-2mm, 5mm) rectangle ( \columnwidth/2-2mm, 0mm);
\path[fill=black!20] (-\columnwidth/4-1mm-2mm, 15mm) rectangle (-\columnwidth/4-1mm+2mm, 0mm);
\path[fill=black!20] ( \columnwidth/4-1mm-2mm, 15mm) rectangle ( \columnwidth/4-1mm+2mm, 0mm);
...
\node[color=richblack] at (0, 7mm) {\tableheader \contour{white}{Ethereal Border}};
\node[color=richblack] at (0, 2.5mm) {\tableheader The Gray};
\node[color=richblack] at (0, -5mm) {\tableheader Material Plane};
\node[color=richblack, rotate=90] at (-\columnwidth/4-1mm, 7.5mm) {\textit{Conduit}};
\node[color=richblack, rotate=90] at ( \columnwidth/4-1mm, 7.5mm) {\textit{Conduit}};
\end{scope}
\end{tikzpicture}
\end{figure}
