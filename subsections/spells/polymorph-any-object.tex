...
\tableheader Duration Factor & \tableheader Duration & \tableheader Example\\
	...
	Unlike \spell{polymorph}, \emph{polymorph any object} does grant the creature the Intelligence score of its new form. If the original form didn't have a Wisdom or Charisma score, it gains those scores as appropriate for the new form.

	Damage taken by the new form can result in the injury or death of the \emph{polymorphed} creature. In general, damage occurs when the new form is changed through physical force.
	...
	This spell can also be used to duplicate the effects of \spell{baleful polymorph}, \spell{polymorph}, \spell{flesh to stone}, \spell{stone to flesh}, \spell{transmute mud to rock}, \spell{transmute metal to wood}, or \spell{transmute rock to mud}.
