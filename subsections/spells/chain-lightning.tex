...
{
	This spell creates an electrical discharge that begins as a single stroke commencing from your fingertips. Unlike \spell{lightning bolt}, \emph{chain lightning} strikes one object or creature initially, then arcs to other targets.
