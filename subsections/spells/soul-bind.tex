...
{
	You draw the soul from a newly dead body and imprison it in a black sapphire gem. The subject must have been dead no more than 1 round per caster level. The soul, once trapped in the gem, cannot be returned through \spell{clone}, \spell{raise dead}, \spell{reincarnation}, \spell{resurrection}, \spell{true resurrection}, or even a \spell{miracle} or a \spell{wish}. Only by destroying the gem or dispelling the spell on the gem can one free the soul (which is then still dead).
