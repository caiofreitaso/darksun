...
}
{
	...
	The \emph{snare} is magical. To escape, a trapped creature must make a DC 23 \skill{Escape Artist} check or a DC 23 Strength check that is a full-round action. The \emph{snare} has AC 7 and 5 hit points. A successful escape from the \emph{snare} breaks the loop and ends the spell.
