...
}
{
	...
	Multiple effects that increase a weapon's threat range (such as the \emph{keen edge} spell and the \feat{Improved Critical} feat) don't stack. You can't cast this spell on a natural weapon, such as a claw.
