...
}
{
	...
	The eyes exist for up to 1 hour per caster level or until they return to you. The \spell{dispel magic} spell can destroy eyes. Roll separately for each eye caught in an area dispel. Of course, if an eye is sent into darkness, it could hit a wall or similar obstacle and destroy itself.
