...
}
{
	...
	The colors of the sphere have the same effects as the colors of a \spell{prismatic wall}.

	\emph{Prismatic sphere} can be made permanent with a \spell{permanency} spell.
