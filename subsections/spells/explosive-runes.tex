...
}
{
	...
	\textit{Note:} Magic traps such as explosive runes are hard to detect and disable. A rogue (only) can use the \skill{Search} skill to find the runes and \skill{Disable Device} to thwart them. The DC in each case is 25 + spell level, or 28 for explosive runes.
