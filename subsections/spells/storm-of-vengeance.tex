...
}
{
	...
	Ranged attacks within the area of the storm are impossible. Spells cast within the area are disrupted unless the caster succeeds on a \skill{Concentration} check against a DC equal to the \emph{storm of vengeance}'s save DC + the level of the spell the caster is trying to cast.
