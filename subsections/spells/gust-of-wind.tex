...
}
{
	...
	Any creature, regardless of size, takes a $-4$ penalty on ranged attacks and \skill{Listen} checks in the area of a \emph{gust of wind}.
	...
	\emph{Gust of wind} can be made permanent with a \spell{permanency} spell.
