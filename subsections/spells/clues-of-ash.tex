...
}
{
	...
	You can also tell whether the object was destroyed by defiler destruction or not. If vegetation destroyed by defiling is tested, you can make a \skill{Spellcraft} check (DC 15 + spell level) to determine the school of magic cast.
}
