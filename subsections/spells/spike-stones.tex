...
}
{
	...
	\textbf{Note:} Magic traps such as \emph{spike stones} are hard to detect. A rogue (only) can use the \skill{Search} skill to find \emph{spike stones}. The DC is 25 + spell level, or DC 29 for \emph{spike stones}.
