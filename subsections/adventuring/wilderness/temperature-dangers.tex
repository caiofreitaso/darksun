...
Extreme heat   & 61 °C to 82 °C       & 10 minutes & 1d6 lethal\footnotemark[1] + 1d4 nonlethal \\
...
Extreme cold   & $-45$ °C to $-29$ °C & 10 minutes & 1d6 lethal\footnotemark[1] + 1d4 nonlethal \\
Unearthly cold & $-46$ °C or lower    & 1 minute   & 1d6 lethal\footnotemark[1] + 1d4 nonlethal\footnotemark[1] \\
...
\BigTablePair{Random Weather}{lL*{6}{l}}{
  \tableheader d\%
& \tableheader Weather
...
\textit{Treating hypotermia:} A successful DC 15 \skill{Heal} check can lower the level of hypothermia of the victim by one level (severe to moderate, moderate to mild, mild to none). The DC is modified by the snow cave, den, or similar shelter, can gain a bonus to their conditions listed in the table below.
