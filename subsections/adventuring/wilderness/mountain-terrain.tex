...
\textbf{Dense Rubble}: The ground is covered with rocks of all sizes. It costs 2 squares of movement to enter a square with dense rubble. The DC of \skill{Balance} and \skill{Tumble} checks on dense rubble increases by 5, and the DC of Move Silently checks increases by +2.
