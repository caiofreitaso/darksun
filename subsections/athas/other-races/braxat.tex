\Figure{b}{images/braxat-2.png}
\Figure*{b}{images/dray.png}
...
\begin{itemize*}
	...
	\item Large: As a Large creature, a braxat takes a $-1$ penalty to Armor Class, a $-1$ penalty on attack rolls, and a $-4$ penalty on \skill{Hide} checks. He gains a +4 size bonus on grapple checks, and his lifting and carrying limits are double those of Medium characters, but he uses bigger weapons than humans use.
