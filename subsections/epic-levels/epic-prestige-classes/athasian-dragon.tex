...
{\EpicTable}
{
 1st & +1  & +2 & +2 & +2 & Continued advancement, divine rank, obsidian focus, \spell{tongues} & 1 \\
...
A dragon can cast only a certain number of psionic enchantments per day. His daily psionic enchantment allotment is given on \tabref{The Athasian Dragon}. Unlike spells, he does not receive bonus psionic enchantments per day.
