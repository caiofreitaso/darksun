...
\Feat[Epic]{Legendary Detective}
{}
{Cha 25, \feat{Urban Tracking}, \skill{Diplomacy} 24 ranks, \skill{Gather Information} 24 ranks.}
{You ignore any check penalties applied to avoid suspicion or to cut the time between checks for tracking. }
{Without this feat, you take a $-5$ penalty on \skill{Gather Information} checks to cut the time between checks for tracking, or a $-20$ penalty when attempting to avoid suspicion.}
{}
