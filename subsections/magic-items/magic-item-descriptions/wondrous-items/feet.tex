...
\textbf{Boots of Striding and Springing:} These boots increase the wearer's base land speed by 10 feet. In addition to this striding ability (considered an enhancement bonus), these boots allow the wearer to make great leaps. She can jump with a +5 competence bonus on \skill{Jump} checks.

Faint transmutation; CL 3rd; \feat{Craft Wondrous Item}, \spell{longstrider}, creator must have 5 ranks in the \skill{Jump} skill; Price 5,500 cp; Weight 0.5 kg.
...
\textbf{Boots, Winged:} These boots appear to be ordinary footgear. On command, the boots sprout wings at the heel and let the wearer fly, without having to maintain concentration, as if affected by a \spell{fly} spell. He can fly three times per day for up to 5 minutes per flight.
