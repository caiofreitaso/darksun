\Table{Specific Weapons}{LR}{ \\
Sleep arrow                    & 132 cp \\
Screaming bolt                 & 267 cp \\
Javelin of lightning           & 1,500 cp \\
Masterwork cold iron longsword & 1,800 cp \\
Slaying arrow                  & 2,282 cp \\
Silver dagger, masterwork      & 2,500 cp \\
Shatterspike                   & 5,800 cp \\
Dagger of venom                & 8,302 cp \\
Assassin's dagger              & 18,302 cp \\
Luck blade                     & 22,060 cp \\
Flame tongue                   & 22,200 cp \\
Nine lives stealer             & 23,052 cp \\
Sword of subtlety              & 23,300 cp \\
Sword of the planes            & 23,800 cp \\
Oathbow                        & 25,600 cp \\
Sword of life stealing         & 27,200 cp \\
Mace of terror                 & 39,047 cp \\
Life-drinker                   & 40,310 cp \\
Rapier of puncturing           & 50,310 cp \\
Sun blade                      & 53,800 cp \\
Frost brand                    & 54,450 cp \\
Adamantine dagger              & 300,200 cp \\
Adamantine battleaxe           & 301,000 cp \\
Mace of smiting                & 373,500 cp \\
}
